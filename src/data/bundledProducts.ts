...
export const defaultProductDatabase: ProductDatabase = {
  products: {
    volume_root_clips: {
      ...
      tags: ['style', 'featured'],
      description:
        'These clips are specially designed to help you create volume at the roots of your hair',
      buy_links: [
        {
    ...
    volume_edgelift_brush: {
      ...
      tags: ['style', 'featured'],
      description:
        'The Volume EdgeLift Brush is a unique tool that helps you create voluminous curls/waves',
      buy_links: [
        {
    ...
    define_edgelift_brush: {
      ...
      tags: ['style', 'featured'],
      description:
        'The Define EdgeLift Brush is a unique brush that helps define your curls/waves',
      buy_links: [
        {
    ...
    curly_girl_microfiber_super_absorbent_anti_frizz_hair_towel: {
      ...
      asin: 'B09D8PL1N5',
      description:
        'Help your hair dry faster and reduce frizz with a microfiber towel.',
    ...
    curl_friendly_soft_headbands: {
      ...
      description:
        "These headbands are made by the creator of CurlsBot from soft, stretchy fabric that won't snag or pull on your curls. They're perfect for keeping your hair out of your face and creating lovely styles that won't damage your hair.",
    ...
    curly_hair_accessories_kit: {
      ...
      brand: 'Lohy',
      description:
        "A full kit of Lohy's most useful accessories such as a sleep turban, volume clips, and innovative hydration glove",
      tags: ['style', 'featured'],
      product_categories: ['accessories'],
      buy_links: [
        {
    ...
    'pop-up_curl_diffuser': {
      ...
      tags: ['style', 'featured'],
      description:
        "Great for travel though I've used it at home for years because it's so easy to store",
      buy_links: [
        {
    ...
    clarifying_shampoo: {
      ...
      buy_links: [
        {
          url: 'https://amzn.to/3RLg09y',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['clarifying_shampoos'],
      tags: ['samples', 'wavy', 'curly', 'coily', 'low_porosity', 'protein'],
      ingredients_raw:
      ...
      description:
        'Remove buildup from products, pollutants, and hard water with this salon-grade clarifying wash',
      ...
      extensions: {
        frizzbot: {
          ...
          emollients_number: 2,
          simple_humectants: ['Propanediol', 'Glycerin', 'Ethylhexylglycerin'],
          ...
          emollients: ['Unknown Polyquat', 'Cetrimonium Chloride'],
          score: -66,
        },
        porosity: {
          high: 100,
    ...
    'wash_&_scrub_detox_shampoo': {
      ...
      tags: ['low_porosity', 'normal_porosity', 'featured', 'protein-free'],
      buy_links: [
        {
    ...
    water_works_clarifying_shampoo: {
      ...
      brand: 'Ouidad',
      product_categories: ['clarifying_shampoos', 'shampoos'],
      tags: [
        'low_porosity',
        'normal_porosity',
        'premium',
      ...
      description:
        'A strong, sulfate-based cleanser designed to deep-clean the scalp and hair, removing product buildup, oils, and residues.',
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 0,
          emollients_number: 3,
          simple_humectants: ['Butylene glycol', 'Panthenol'],
          film_forming_humectants: [],
          emollients: [
    ...
    gentle_clarifying_shampoo: {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants: ['Unknown Protein'],
          emollients: [
            'Unknown Polyquat',
    ...
    natural_detox_hair_mask: {
      ...
      asin: 'B09YS5YRTR',
      description:
        'This mask is a great gentle option for removing stubborn buildup without stripping out your natural oils.',
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 1,
          emollients_number: 6,
          simple_humectants: ['Glycerin', 'Panthenol'],
          film_forming_humectants: ['Hydrolyzed Quinoa'],
          emollients: [
            'Cetearyl Alcohol',
            'Rice bran oil',
    ...
    scalp_care_clarifying_shampoo: {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 1,
          emollients_number: 3,
          simple_humectants: ['Glycerin', 'Hexylene Glycol'],
          film_forming_humectants: ['Aloe Barbadensis Leaf Extract'],
          emollients: [
            'Butyrospermum Parkii Shea Butter',
            'Unknown Polyquat',
            'Guar Hydroxypropyltrimonium Chloride',
    ...
    curl_reset_detox_shampoo: {
      ...
      asin: 'B08636L8JY',
      description:
        'This shampoo was recently reformulated to remove not just product buildup, but also mineral buildup from hard water.',
      cost: 2.6,
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 0,
          emollients_number: 3,
          simple_humectants: ['Glycerin', 'Propanediol'],
          film_forming_humectants: [],
          emollients: [
            'Acrylates Copolymer',
            'Unknown Polyquat',
    ...
    'perfect_clean_2-in-1_scalp_scrub_&_shampoo': {
      name: 'Perfect Clean 2-in-1 Scalp Scrub & Shampoo',
      brand: 'NatureLab Tokyo',
      buy_links: [
        {
          url: 'https://www.ulta.com/p/perfect-clean-2-in-1-scalp-scrub-clarifying-shampoo-pimprod2013672?sku=2564029',
          retailer: 'Ulta',
        },
      ],
      product_categories: ['clarifying_shampoos', 'treatments'],
      tags: ['samples', 'wavy', 'curly', 'coily', 'low_porosity', 'protein'],
      ingredients_raw:
      ...
      description:
        'A 2-in-1 scalp scrub and clarifying shampoo that gently removes buildup and impurities to reveal a healthy scalp and immensely shiny hair',
      id: 'perfect_clean_2-in-1_scalp_scrub_&_shampoo',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants: ['Glutamic Acid'],
          emollients: [
            'Castor Oil',
            'Butyrospermum Parkii Shea Butter',
            'Coconut Oil',
    ...
    daily_conditioner: {
      ...
      product_categories: ['conditioners'],
      tags: ['normal_porosity', 'high_porosity', 'protein'],
      ingredients_raw:
    ...
    hydrating_cream_conditioner: {
      ...
      product_categories: ['conditioners'],
      tags: ['high_porosity', 'normal_porosity', 'protein'],
      buy_links: [
        {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 4,
          emollients_number: 9,
          simple_humectants: ['Glycerin', 'Glycerin'],
          film_forming_humectants: [
            'Aloe Barbadensis Leaf Extract',
            'Hydroxyethylcellulose',
            'Unknown Protein',
    ...
    clarity_conditioner: {
      ...
      product_categories: ['conditioners'],
      tags: ['normal_porosity', 'protein-free'],
      buy_links: [
        {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 1,
          emollients_number: 7,
          simple_humectants: ['Glycerin', 'Honey'],
          film_forming_humectants: ['Aloe Barbadensis Leaf Extract'],
          emollients: [
            'Cetearyl Alcohol',
            'Behentrimonium Methosulfate',
    ...
    'drench_&_quench_rich_conditioner': {
      ...
      brand: 'Lohy',
      product_categories: ['conditioners', 'deep_conditioners'],
      tags: ['high_porosity', 'normal_porosity', 'protein'],
      ingredients_raw:
    ...
    essential_moisture_conditioner: {
      ...
      brand: 'Curlsmith',
      product_categories: ['conditioners'],
      tags: ['normal_porosity', 'high_porosity', 'protein-free'],
      ingredients_raw:
      ...
      cost: 1.6,
      description:
        "This has a small amount of isopropyl alcohol, which we mark as caution, but as it's last on the ingredients list and this is a product meant to be washed out, it's unlikely to be harmful for hair.",
    ...
    tea_tree_triple_treat_invigorating_conditioner: {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 1,
          emollients_number: 7,
          simple_humectants: ['Glycerin', 'Panthenol', 'Ethylhexylglycerin'],
          film_forming_humectants: ['Aloe Barbadensis Leaf Extract'],
          emollients: [
            'Cetyl Alcohol',
            'Stearyl Alcohol',
    ...
    'behentrimonium_chloride_2%_conditioner': {
      ...
      description:
        'With only 7 ingredients and no oils, this conditioner is ideal for those with low porosity hair.',
      buy_links: [
        {
          url: 'https://amzn.to/40IHa63',
          retailer: 'Amazon',
        },
        {
      ...
      id: 'behentrimonium_chloride_2%_conditioner',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    tropical_coconut_conditioner: {
      ...
      brand: 'Suave',
      product_categories: ['conditioners'],
      tags: ['normal_porosity', 'low_porosity', 'protein', 'glycerin-free'],
      cost: 0.09,
      buy_links: [
        {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 1,
          emollients_number: 2,
          simple_humectants: ['Lactic Acid', 'Propylene Glycol', 'Honey'],
          film_forming_humectants: ['Silk Amino Acids'],
          emollients: ['Cetyl Alcohol', 'Stearamidopropyl Dimethylamine'],
          score: -51,
        },
        porosity: {
          high: 100,
    ...
    cream_conditioner: {
      ...
      brand: 'Curl Keeper',
      product_categories: ['conditioners'],
      tags: ['featured', 'protein', 'glycerin-free'],
      cost: 3,
      ingredients_raw:
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 2,
          emollients_number: 4,
          simple_humectants: ['Panthenol', 'Lecithin'],
          film_forming_humectants: ['Silk Amino Acids', 'Wheat Amino Acids'],
          emollients: [
            'Cetearyl Alcohol',
            'Jojoba Oil',
            'Cetrimonium Chloride',
    ...
    big_energy_conditioner: {
      ...
      brand: 'Curl Keeper',
      product_categories: ['conditioners'],
      tags: ['samples', 'wavy', 'curly', 'low_porosity', 'protein-free'],
      cost: 2.8,
      ingredients_raw:
      ...
      description:
        'An ultra-lightweight conditioner to keep hair big, bouncy, and full of life',
    ...
    curl_jelly_conditioner: {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 1,
          emollients_number: 6,
          simple_humectants: ['Glycerin', 'Ethylhexylglycerin'],
          film_forming_humectants: ['Carrageenan'],
          emollients: [
            'Cetearyl Alcohol',
            'Coconut Oil',
            'Cetrimonium Chloride',
    ...
    detangling_conditioner: {
      ...
      brand: 'Tootilab',
      product_categories: ['conditioners'],
      tags: ['women-owned', 'featured', 'protein-free'],
      ingredients_raw:
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants: ['Hydroxyethylcellulose'],
          emollients: [
            'Cetearyl Alcohol',
            'Behentrimonium Chloride',
            'Cetrimonium Chloride',
    ...
    'no._5_bond_maintenance_conditioner': {
      name: 'No. 5 Bond Maintenance Conditioner',
      brand: 'Olaplex',
      buy_links: [
        {
          url: 'https://olaplex.com/products/olaplex-n-5-bond-maintenance-conditioner-us',
          retailer: 'Olaplex',
        },
        {
          url: 'https://www.lookfantastic.com/p/olaplex-no.5-fine-bond-maintenance-conditioner-250ml/16162872/',
      ...
      product_categories: ['conditioners'],
      tags: ['samples', 'wavy', 'curly', 'coily', 'premium', 'protein'],
      ingredients_raw:
      ...
      description:
        'A highly concentrated conditioner with Olaplex’s bonding technology that repairs hair prone to damage or dryness',
    ...
    crack_conditioner: {
      ...
      description:
        'A rare find: a conditioner that does not contain any ingredients known to feed Malassezia, the fungus that causes seborrheic dermatitis.',
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 2,
          emollients_number: 4,
          simple_humectants: ['Panthenol', 'Glycerin'],
          film_forming_humectants: [
            'Hydrolyzed Wheat Protein',
            'Sodium Glutamate',
          ],
    ...
    'coil_infusion®_drink_up™_cleansing_conditioner': {
      ...
      brand: 'Ouidad',
      product_categories: ['cowashes'],
      tags: ['featured', 'protein'],
      ingredients_raw:
      ...
      description:
        'A luxurious, multi-functional cleanser that deeply conditions and moisturizes while gently cleansing.',
      buy_links: [
        {
    ...
    coconut_cowash_cleansing_conditioner: {
      ...
      description:
        'A creamy, conditioning cleanser formulated to gently clean while deeply moisturizing.',
      asin: 'B00641UCY8',
    ...
    'co-wash_conditioning_cleanser': {
      ...
      tags: ['protein'],
      description:
        'A moisturizing, non-stripping cleanser and conditioner hybrid designed for textured, dry, or curly hair.',
      asin: 'B005SIR5G6',
      cost: 2.12,
    ...
    curl_quenching_conditioning_wash: {
      ...
      description:
        'A 2-in-1 shampoo and conditioner that gently cleanses buildup, soothes the scalp, promotes healthy hair growth, and boosts shine',
      buy_links: [
        {
        ...
        {
          url: 'https://www.lookfantastic.com/p/curlsmith-curl-quenching-conditioning-wash-355ml/12691568/',
          retailer: 'Look Fantastic',
          countries: ['EU'],
        },
      ],
    ...
    curl_shaper_double_duty_weightless_cleansing_conditioner: {
      ...
      brand: 'Ouidad',
      product_categories: ['cowashes'],
      tags: ['featured', 'protein-free', 'glycerin-free'],
      buy_links: [
        {
      ...
      description:
        'A gentle low pH cleanser. Has a volatile alcohol (isopropyl alcohol) but low on the ingredients list and this is less of a concern in a wash-out product.',
    ...
    lemon_buttercream_styling_cream: {
      ...
      description:
        'A botanical-rich, moisturizing, and detangling cream designed to condition, soften, and support hair and scalp health',
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 2,
          emollients_number: 1,
          simple_humectants: ['Sodium PCA', 'Panthenol', 'Glycerin'],
          film_forming_humectants: [
            'Marshmallow root Extract',
            'Flaxseed Extract',
          ],
          emollients: ['Cetearyl Alcohol'],
          score: -82,
        },
        porosity: {
          high: 85,
    ...
    i_create_volume: {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 2,
          emollients_number: 1,
          simple_humectants: ['Glycerin', 'Honey', 'Sorbitol'],
          film_forming_humectants: [
            'Aloe Barbadensis Leaf Extract',
            'Unknown Protein',
          ],
    ...
    curly_hair_cream: {
      ...
      product_categories: ['creams'],
      tags: ['curl_enhancer', 'featured', 'protein-free'],
      ingredients_raw:
      ...
      asin: 'B0CHWM9YCJ',
      description:
        'A multi-functional protective hair styling cream that helps protect and define curls',
      id: 'curly_hair_cream',
      systems_excluded: [],
      status: 'ok',
      extensions: {
    ...
    pinapple_swirl_curl_defining_cream: {
      name: 'Pinapple Swirl Curl Defining Cream',
      brand: 'Pacifica',
      product_categories: ['creams'],
      tags: ['featured', 'protein-free', 'glycerin-free'],
      cost: 3,
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 2,
          emollients_number: 5,
          simple_humectants: ['Sodium hyaluronate', 'Ethylhexylglycerin'],
          film_forming_humectants: [
            'Flaxseed Extract',
            'Hydroxyethylcellulose',
          ],
    ...
    'avocado_&_rose_oil_clump_&_define_cream': {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 2,
          emollients_number: 8,
          simple_humectants: ['Sorbitol', 'Glycerin', 'Ethylhexylglycerin'],
          film_forming_humectants: [
            'Aloe Barbadensis Leaf Extract',
            'Hydroxyethylcellulose',
          ],
    ...
    light_hold_creme_gel: {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 3,
          emollients_number: 1,
          simple_humectants: ['Glycerin', 'Caprylyl Glycol', 'Hexylene Glycol'],
          film_forming_humectants: [
            'Hydrolyzed Quinoa',
            'Hydrolyzed Oat Protein',
            'Aloe Barbadensis Leaf Extract',
          ],
          emollients: ['VP VA copolymer'],
          score: -69,
        },
        porosity: {
          high: 81,
    ...
    the_curl_creme: {
      ...
      brand: 'Shirley Jane',
      product_categories: ['creams'],
      tags: ['woman_owned', 'small_business', 'protein'],
      ingredients_raw:
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants: ['Sodium Glutamate'],
          emollients: [
            'Behentrimonium Methosulfate',
            'Avocado Oil',
            'Cetyl Alcohol',
    ...
    curl_passion_curl_perfectionist: {
      name: 'Curl Passion Curl Perfectionist',
      brand: 'Milk_Shake',
      buy_links: [
        {
          url: 'https://www.milkshakehair.com/products/milk_shake-lifestyling-curl-perfectionist',
          retailer: 'Milk_Shake',
        },
        {
          url: 'https://amzn.to/3Sh9FCN',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['creams'],
      ...
      description:
        'Tames frizz, enhances natural texture, provides light hold, and contains protein for added strength',
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants: ['Unknown Protein', 'Hydrolyzed Quinoa'],
          emollients: [
            'Cyclopentasiloxane',
            'Myristyl Alcohol',
            'Stearyl Alcohol',
    ...
    curl_enhancing_custard: {
      ...
      product_categories: ['custards', 'gels'],
      tags: [
        'low_porosity',
        'curl_enhancer',
        'normal_porosity',
      ...
      description:
        'A lightweight custard that provides hold, enhances volume, and conditions with seaweed and honey',
      asin: 'B005SIR12E',
      cost: 2.3,
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 7,
          emollients_number: 0,
          simple_humectants: ['Glycerin', 'Sorbitol', 'Ethylhexylglycerin'],
          film_forming_humectants: [
            'Aloe Barbadensis Leaf Extract',
            'Pectin',
            'Hydroxypropyltrimonium Honey',
    ...
    curl_defining_styling_souffle: {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 3,
          emollients_number: 3,
          simple_humectants: ['Glycerin', 'Sorbitol'],
          film_forming_humectants: [
            'Carrageenan',
            'Flaxseed Extract',
            'Aloe Barbadensis Leaf Extract',
    ...
    curling_jelly_coil_and_curl_definer_: {
      ...
      brand: 'As I Am',
      ingredients_raw:
        'aqueous, water, aqua purificada, purified extracts aloe barbadensis leaf, beta vulgaris beet root, glycerin, hydroxyethylcellulose, xanthan gum, pectin, citric acid, tocopheryl acetate, potassium sorbate, diazolidinyl urea and iodopropynyl butylcarbamate, fragrance parfum, limonene',
      product_categories: ['custards', 'gels'],
      tags: [
        'low_porosity',
        'normal_porosity',
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 2,
          emollients_number: 1,
          simple_humectants: ['Glycerin', 'Urea'],
          film_forming_humectants: ['Hydroxyethylcellulose', 'Pectin'],
          emollients: ['Xanthan Gum'],
          score: -68,
        },
        porosity: {
          high: 85,
    ...
    "rockin'_ringlets_styling_potion": {
      ...
      ingredients_raw:
        'aqua water, linum usitatissimum linseed flaxseed extract, glycerin, simmondsia chinensis jojoba seed oil, aloe barbadensis aloe vera leaf juice powder, magnesium sulfate, benzoic acid, dehydroacetic acid, phenoxyethanol',
      description:
        'A unique liquid gel that moisturizes with natural film-forming humectants and helps enhance and define curls',
      product_categories: ['custards', 'gels'],
      tags: [
        'low_porosity',
        'normal_porosity',
    ...
    curling_custard: {
      ...
      brand: 'Kinky Curly',
      ingredients_raw:
        'botanical infusion of water aqua, equisetum arvense horsetail, chamomile, urtica dioica nettle, althea officinalis, marshmallow, organic aloe vera juice, agave tequilana, agave nectar extract, tocopheryl acetate vitamin e, pectin, citric acid, potassium sorbate, fragrance',
      product_categories: ['custards', 'gels'],
      tags: [
        'low_porosity',
        'normal_porosity',
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 3,
          emollients_number: 0,
          simple_humectants: ['Agave Nectar', 'Agave Nectar'],
          film_forming_humectants: [
            'Marshmallow root Extract',
            'Aloe Barbadensis Leaf Extract',
            'Pectin',
    ...
    banana_cream_deep_conditioner: {
      ...
      brand: 'Ecoslay',
      ingredients_raw:
        'okra extract, marshmallow root extract, aloe vera juice, coconut cream, behentrimonium methosulfate, ceteryl alcohol, avocado oil, argan oil, jojoba oil, benzyl alcohol dehydroacetic acid, banana extract',
      ...
      asin: 'B09D8PL1N5',
      description:
        'A rich, plant-powered treatment ideal for restoring and repairing curly, dry, or damaged hair',
    ...
    deep_conditioning_treatment: {
      ...
      asin: 'B00684AC82',
      description:
        'A deeply moisturizing conditioner ideal for daily use on coarse hair or as a treatment for medium textures, delivering intense hydration with a rich, herbal blend and no buildup',
    ...
    'deep_conditioner_&_repair': {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 2,
          emollients_number: 8,
          simple_humectants: ['Panthenol', 'Ethylhexylglycerin'],
          film_forming_humectants: [
            'Aloe Barbadensis Leaf Extract',
            'Hydroxyethylcellulose',
          ],
    ...
    lemon_drop_styling_foam: {
      name: 'Lemon Drop Styling Foam',
      brand: 'Ecoslay',
      ingredients_raw:
        'purified water aqua, mel, hydrolyzed corn starch, sodium polyitaconate, sucrose, propanediol, capryl caprylyl glucoside, linum usitatissimum seed extract, althaea officinalis root extract, antimicro root blend preservative bulb extract, caprylyl glycol, wasabia japonica root extract, zingiber officinale root extract, citrus limon peel oil, citrus aurantium bergamia fruit oil',
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 2,
          emollients_number: 0,
          simple_humectants: ['Propanediol', 'Caprylyl Glycol'],
          film_forming_humectants: [
    ...
    i_create_lift_volumizing_foam: {
      ...
      cost: 4.6,
      id: 'i_create_lift_volumizing_foam',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    bouncy_strength_volume_foam: {
      ...
      asin: 'B08WPSW84H',
      description:
        'A lightweight foam helps build volume and provides humidity protection',
      cost: 2.6,
      ...
      extensions: {
        frizzbot: {
          ...
          simple_humectants: ['Glycerin', 'Panthenol', 'Ethylhexylglycerin'],
          film_forming_humectants: ['Unknown Protein'],
          emollients: ['VP VA copolymer', 'Castor Oil', 'Benzyl Alcohol'],
          score: -70,
        },
        porosity: {
          high: 72,
    ...
    curl_boosting_hair_mousse: {
      ...
      product_categories: ['foams'],
      ingredients_raw:
        'water, isobutane, propane, polyquaternium-4, phenoxyethanol, propylene glycol, fragrance, c9-11 pareth-8, caprylyl glycol, 12-hexanediol, disodium edta, citric acid',
      tags: [
        'normal_porosity',
        'volume',
        'low_porosity',
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 0,
          emollients_number: 1,
          simple_humectants: ['Propylene Glycol', 'Caprylyl Glycol'],
          film_forming_humectants: [],
          emollients: ['Unknown Polyquat'],
          score: -18,
        },
        porosity: {
          high: 100,
    ...
    jello_shot_curl_defining_gel: {
      ...
      brand: 'Ecoslay',
      ingredients_raw:
        'water, okra extract, aloe vera juice, pectin, chamomile flower extract, nettle leaf extract, melissa leaf extract, peppermint leaf extract, horsetail leaf extract, yucca vera leaf extract, propanediol, aminopropanol, strawberry fruit essence, benzyl alcohol dehydroacetic acid, carbomer 980, sodium gluconate',
      product_categories: ['gels'],
      tags: [
        'normal_porosity',
        'high_porosity',
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 2,
          emollients_number: 1,
          simple_humectants: ['Propanediol'],
          film_forming_humectants: ['Aloe Barbadensis Leaf Extract', 'Pectin'],
          emollients: ['Benzyl Alcohol'],
          score: -91,
        },
        porosity: {
          high: 100,
    ...
    orange_marmalade_flaxseed_and_aloe_curl_definer: {
      name: 'Orange Marmalade Flaxseed and Aloe Curl Definer',
      brand: 'Ecoslay',
      ingredients_raw:
      ...
      product_categories: ['gels', 'custards'],
      tags: [
        'normal_porosity',
        'high_porosity',
        'low_porosity',
      ...
      description:
        'CurlsBot note: This is the main styling product I use on my own hair- Melissa',
      buy_links: [
        {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 4,
          emollients_number: 1,
          simple_humectants: ['Agave Nectar'],
          film_forming_humectants: [
            'Flaxseed Extract',
            'Pectin',
            'Aloe Barbadensis Leaf Extract',
    ...
    'advanced_climate_control_heat_&_humidity_gel': {
      ...
      product_categories: ['gels'],
      tags: ['samples', 'wavy', 'curly', 'coily', 'protein'],
      cost: 3,
      description:
        "Ouidad's best-selling gel that protects against frizz in even the most humid conditions",
      buy_links: [
        {
    ...
    'coil_infusion®_good_shape®_defining_gel': {
      ...
      brand: 'Ouidad',
      product_categories: ['gels'],
      tags: ['normal_porosity', 'high_porosity', 'featured', 'protein'],
      cost: 3.5,
      buy_links: [
        {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 4,
          emollients_number: 9,
          simple_humectants: ['Panthenol', 'Glycerin', 'Caprylyl Glycol'],
          film_forming_humectants: [
            'Hydrolyzed Wheat Protein',
            'Aloe Barbadensis Leaf Extract',
            'Silk',
    ...
    curl_enhancer_gel: {
      ...
      extensions: {
        frizzbot: {
          ...
          emollients_number: 2,
          simple_humectants: ['Glycerin', 'Ethylhexylglycerin', 'Panthenol'],
          film_forming_humectants: [
            'Aloe Barbadensis Leaf Extract',
            'Hydroxyethylcellulose',
            'Hydroxypropyltrimonium Honey',
          ...
          emollients: ['Maltodextrin VP Copolymer', 'Unknown Polyquat'],
          score: -89,
        },
        porosity: {
          high: 100,
    ...
    pow_strong_hold_gel: {
      ...
      product_categories: ['gels'],
      tags: ['normal_porosity', 'low_porosity', 'hold', 'featured', 'protein'],
      buy_links: [
        {
      ...
      extensions: {
        frizzbot: {
          ...
          emollients: ['Unknown Polyquat', 'VP VA copolymer'],
          score: -72,
        },
        porosity: {
          high: 100,
    ...
    'hydro_style_flexi-jelly': {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants: [],
          emollients: ['Polyvinylpyrrolidone', 'Castor Oil'],
          score: -32,
        },
        porosity: {
          high: 59,
    ...
    la_hold_styling_gel: {
      ...
      extensions: {
        frizzbot: {
          ...
          emollients: ['VP VA copolymer', 'Sunflower Oil'],
          score: -90,
        },
        porosity: {
          high: 89,
    ...
    curl_keeper_original_liquid_styler: {
      ...
      brand: 'Curl Keeper',
      product_categories: ['gels'],
      tags: ['samples', 'wavy', 'curly', 'coily', 'protein-free'],
      cost: 2.9,
      buy_links: [
        {
      ...
      ingredients_raw:
        'water aqua eau, vp va copolymer, propylene glycol, hydroxyethylcellulose, glycerin, oleth-20, polyquaternium-10, citric acid, dmdm hydantoin',
      description:
        'A water-based formula that reactivates with water for frizz control and curl refresh without buildup',
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 1,
          emollients_number: 2,
          simple_humectants: ['Propylene Glycol', 'Glycerin'],
          film_forming_humectants: ['Hydroxyethylcellulose'],
          emollients: ['VP VA copolymer', 'Unknown Polyquat'],
          score: -54,
        },
        porosity: {
          high: 100,
    ...
    spiralicious: {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 1,
          emollients_number: 3,
          simple_humectants: ['Panthenol', 'Urea'],
          film_forming_humectants: ['Hydroxyethylcellulose'],
          emollients: ['Unknown Polyquat', 'Unknown Polyquat', 'Jojoba Oil'],
          score: -70,
        },
        porosity: {
          high: 100,
    ...
    curl_jelly_scrunching_jelly: {
      ...
      brand: 'Umberto Giannini',
      ingredients_raw:
        'aqua, xanthan gum, propylene glycol, glycerin, phenoxyethanol, acrylates palmeth-25 acrylate copolymer, peg-40 hydrogenated castor oil, polyquaternium-11, sodium benzoate, dipropylene glycol, sodium methylparaben, aminomethyl propanol, parfum, benzophenone-4, coumarin, alpha-isomethyl ionone, linalool, ci 17200',
      product_categories: ['gels'],
      tags: ['protein-free'],
      buy_links: [
        {
    ...
    all_weather_styling_gel: {
      ...
      description:
        'An all-purpose gel that will hold your curls/waves even in humid weather.',
      buy_links: [
        {
    ...
    all_about_curls_high_definition_gel: {
      name: 'All About Curls High Definition Gel',
      brand: 'Zotos',
      buy_links: [
        {
          url: 'https://amzn.to/44k4TvD',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['gels'],
      tags: ['samples', 'wavy', 'curly', 'coily', 'premium', 'protein-free'],
      ingredients_raw:
        'water aqua eau, propylene glycol, acrylates copolymer, aminomethyl propanol, glycerin, peg-60 hydrogenated castor oil, carbomer, hydroxyethylcellulose, quaternium-22, tetrasodium edta, dmdm hydantoin, iodopropynyl butylcarbamate, fragrance parfum',
      description:
        'A color-safe styling gel that delivers strong hold, locks in moisture, and enhances shine for firmly defined, frizz-free curls',
      ...
      extensions: {
        frizzbot: {
          ...
          simple_humectants: ['Propylene Glycol', 'Glycerin'],
          film_forming_humectants: ['Hydroxyethylcellulose'],
          emollients: ['Acrylates Copolymer', 'Castor Oil'],
          score: -35,
        },
        porosity: {
          high: 78,
    ...
    scalp_revitalizing_solution_miracle_in_shower_treatment: {
      name: 'Scalp Revitalizing Solution Miracle in Shower Treatment',
      brand: 'Dr. Groot',
      buy_links: [
        {
          url: 'https://amzn.to/3Z01e2q',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['treatments'],
      ...
      description:
        'A hair-thickening treatment that soothes the scalp, boosts growth, and delivers healthier-looking hair in just 5 seconds',
      id: 'scalp_revitalizing_solution_miracle_in_shower_treatment',
      systems_excluded: [],
      status: 'caution',
      extensions: {
        frizzbot: {
    ...
    no_lather_cleanser: {
      name: 'No Lather Cleanser',
      brand: "Zoto's All About Curls",
      buy_links: [
        {
          url: 'https://amzn.to/3EQryFu',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['cowashes'],
      tags: ['samples', 'curly', 'coily', 'high_porosity', 'protein'],
      ingredients_raw:
      ...
      description:
        'A color-safe, no-lather cleanser that gently cleanses and hydrates all curl types for soft, strong, frizz-free curls',
      id: 'no_lather_cleanser',
      systems_excluded: [],
      status: 'caution',
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 1,
          emollients_number: 6,
          simple_humectants: ['Glycerin', 'Lecithin', 'Propylene Glycol'],
          film_forming_humectants: ['Unknown Protein'],
          emollients: [
            'Cetearyl Alcohol',
            'Behentrimonium Chloride',
    ...
    bond_building_shampoo: {
      ...
      description:
        'Gently cleanses while repairing bonds to reduce breakage, tame frizz, and enhance curl definition',
      buy_links: [
        {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 3,
          emollients_number: 4,
          simple_humectants: ['Propanediol', 'Ethylhexylglycerin'],
          film_forming_humectants: [
    ...
    bond_building_conditioner: {
      name: 'Bond Building Conditioner',
      brand: 'Not Your Mothers Curl Talk',
      buy_links: [
        {
          url: 'https://amzn.to/3Si0UbH',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['conditioners'],
      ...
      description:
        'A bond-building conditioner that hydrates, repairs, and reduces breakage, split ends, and frizz for healthier curls',
      id: 'bond_building_conditioner',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    's.o.s._deep_moisture_+_restore_conditioner': {
      name: 'S.O.S. Deep Moisture + Restore Conditioner',
      brand: 'Hairitage',
      buy_links: [
        {
          url: 'https://amzn.to/4cX3MEl',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['deep_conditioners'],
      ...
      description:
        'A deep conditioner that delivers intense hydration, volume, and rejuvenation to dry, damaged strands',
      id: 's.o.s._deep_moisture_+_restore_conditioner',
      systems_excluded: [],
      status: 'warning',
      extensions: {
        frizzbot: {
    ...
    'prime_3-minute_moisture_conditioner': {
      name: 'Prime 3-Minute Moisture Conditioner',
      brand: 'Miche',
      buy_links: [
        {
      ...
      description:
        'A fast-acting conditioner that hydrates, detangles, and smooths, with pro-Vitamin B5 and nourishing botanicals',
      id: 'prime_3-minute_moisture_conditioner',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    curl_respecting_conditioner: {
      ...
      product_categories: ['conditioners'],
      tags: ['samples', 'curly', 'coily', 'protein', 'glycerin-free'],
      ingredients_raw:
      ...
      description:
        'A lightweight conditioner infused with nourishing plant oils to help fingers or combs glide through curls with ease',
    ...
    water_activated_conditioner: {
      name: 'Water Activated Conditioner',
      brand: 'Wakati',
      buy_links: [
        {
          url: 'https://amzn.to/4iK5WIG',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['conditioners'],
      ...
      description:
        'A patented, high-slip formula that makes detangling easy, while smoothing cuticles',
    ...
    rehydr8_moisture_conditioner: {
      name: 'Rehydr8 Moisture Conditioner',
      brand: 'Malibu C',
      buy_links: [
        {
          url: 'https://amzn.to/4iNOPWp',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['conditioners'],
      ...
      description:
        'A deep treatment that delivers intense conditioning to dry, brittle hair, transforming it into soft, shiny strands',
    ...
    illumin8_conditioner: {
      name: 'Illumin8 Conditioner',
      brand: 'Malibu C',
      buy_links: [
        {
          url: 'https://amzn.to/44R62uM',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['conditioners'],
      ...
      description:
        'An oil-fusion treatment that infuses lightweight, non-greasy emollients to boost shine ',
      id: 'illumin8_conditioner',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    cream_daily_conditioner: {
      name: 'Cream Daily Conditioner',
      brand: 'All About Curls',
      buy_links: [
        {
          url: 'https://amzn.to/3GOlvSm',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['conditioners'],
      ...
      description:
        'This conditoner leaves your strands silky-soft and easy to detangle and style',
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 1,
          emollients_number: 6,
          simple_humectants: ['Glycerin', 'Honey', 'Lecithin'],
          film_forming_humectants: ['Unknown Protein'],
          emollients: [
            'Cetearyl Alcohol',
            'Behentrimonium Chloride',
    ...
    rehabilit8_smoothing_protein_conditioner: {
      name: 'Rehabilit8 Smoothing Protein Conditioner',
      brand: 'Malibu C',
      buy_links: [
        {
          url: 'https://amzn.to/4k0un5Q',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['conditioners'],
      tags: ['samples', 'wavy', 'curly', 'low_porosity', 'premium', 'protein'],
      ingredients_raw:
      ...
      description:
        'Restores amino acids and proteins to strengthen damaged hair, improve elasticity, and prevent breakage',
      id: 'rehabilit8_smoothing_protein_conditioner',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 4,
          emollients_number: 5,
          simple_humectants: ['Glycerin', 'Butylene glycol', 'Panthenol'],
          film_forming_humectants: [
            'Unknown Protein',
            'Unknown Protein',
            'Unknown Protein',
    ...
    'sunset_rituals:_signature_conditioner': {
      name: 'Sunset Rituals: Signature Conditioner',
      brand: 'Voir',
      buy_links: [
        {
          url: 'https://amzn.to/3SgrMZw',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['conditioners'],
      ...
      description:
        'Smooths frizz, restores shine, and deeply hydrates with moisturizing botanicals plus hyaluronic and lactic acids',
      id: 'sunset_rituals:_signature_conditioner',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants: ['Arginine'],
          emollients: [
            'Brassica Alcohol',
            'Capryloyl Glycerin Sebacic Acid Copolymer',
            'Diheptyl Succinate',
    ...
    restoring_intensive_mask: {
      name: 'Restoring Intensive Mask',
      brand: 'Imbue',
      buy_links: [
        {
          url: 'https://amzn.to/3GOQQo0',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['deep_conditioners'],
      ...
      description:
        'Strengthens and restores while deeply hydrating dry, damaged hair with a blend of plant-based oils and butters',
      id: 'restoring_intensive_mask',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 3,
          emollients_number: 7,
          simple_humectants: ['Propylene Glycol', 'Panthenol'],
          film_forming_humectants: [
            'Unknown Protein',
            'Unknown Protein',
            'Hydrolyzed Wheat Protein',
    ...
    therapy_session_hair_mask: {
      name: 'Therapy Session Hair Mask',
      brand: 'Eva NYC',
      buy_links: [
        {
          url: 'https://amzn.to/4lPfRj0',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['deep_conditioners'],
      ...
      description:
        'Delivers 48-hour smoothness while deeply conditioning and repairing hair to be 2X stronger and 3X more hydrated',
      id: 'therapy_session_hair_mask',
      systems_excluded: [],
      status: 'warning',
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 1,
          emollients_number: 8,
          simple_humectants: ['Panthenol', 'Propylene Glycol'],
          film_forming_humectants: [
            'Hydrolyzed Vegetable Protein PG-propyl Silanetriol',
          ],
          emollients: [
    ...
    collagen_mask: {
      ...
      description:
        '100% vegan collagen  supports healthy hair growth, enhances strength, and helps prevent age-related thinning',
      id: 'collagen_mask',
      systems_excluded: [],
      status: 'caution',
      extensions: {
    ...
    honey_chia_smoothing_mask: {
      name: 'Honey Chia Smoothing Mask',
      brand: 'Sauce Beauty',
      buy_links: [
        {
          url: 'https://amzn.to/4cYnGz3',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['deep_conditioners'],
      ...
      description:
        'A rich mask that smoothes and softens curls without weighing them down',
    ...
    bonding_hydration_mask: {
      name: 'Bonding Hydration Mask',
      brand: 'bondbar',
      buy_links: [
        {
          url: 'https://www.sallybeauty.com/hair-care/shop-by-product/hair-treatments/bonding-hydration-mask/SBS-009606.html?srsltid=AfmBOortCLlxM6qcPylGeTrU3R989D3xx0dXMIFj8y26bhh2bQHan9eE',
          retailer: 'Sally Beauty',
        },
      ],
      product_categories: ['deep_conditioners'],
      ...
      description:
        'Boosts conditioning without weighing hair down and improves wet detangling by up to 90% after just one use',
    ...
    rapid_hair_repair: {
      ...
      buy_links: [
        {
          url: 'https://curlkeeper.com/r?id=emtcju',
          retailer: 'Curl Keeper',
        },
      ],
      product_categories: ['deep_conditioners'],
      ...
      description:
        'Restores strength, shine, and pH balance to damaged or color-treated curls while adding volume',
      id: 'rapid_hair_repair',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    strengthen_protein_moisturizing_conditioning_treatment: {
      name: 'Strengthen Protein Moisturizing Conditioning Treatment',
      brand: 'Miche',
      buy_links: [
        {
      ...
      description:
        'Enriched with hydrolyzed Baobab protein to repair damage, strengthen strands, and boost elasticity',
      id: 'strengthen_protein_moisturizing_conditioning_treatment',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    'bonding_pre-shampoo_treatment': {
      ...
      buy_links: [
        ...
        {
          url: 'https://amzn.to/3YrJayf',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['pre-poo'],
      tags: ['samples', 'wavy', 'curly', 'coily', 'bonding', 'protein'],
      ingredients_raw:
      ...
      description:
        'Repairs bonds, prevents split ends, and reduces breakage by 70% while improving detangling by 90% after one use',
    ...
    tough_love_intense_bonding_treatment: {
      ...
      product_categories: ['deep_conditioners', 'treatments'],
      tags: [
        'samples',
        'wavy',
        'curly',
      ...
      description:
        'Strengthens hair, reduces breakage by 56% after one use, and leaves it softer, smoother, and bouncier',
    ...
    coconut_oil_formula_amino_bonding_complex_bonding_conditioning_masque: {
      name: 'Coconut Oil Formula Amino Bonding Complex Bonding Conditioning Masque',
      brand: 'Palmers',
      buy_links: [
        {
          url: 'https://amzn.to/4jE9E8h',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['deep_conditioners'],
      ...
      description:
        'Restores and protects hair bonds weakened by chemicals, styling, or environmental stressors',
      id: 'coconut_oil_formula_amino_bonding_complex_bonding_conditioning_masque',
      systems_excluded: [],
      status: 'caution',
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 4,
          emollients_number: 9,
          simple_humectants: ['Glycerin', 'Ceramide', 'Caprylyl Glycol'],
          film_forming_humectants: [
            'Arginine',
            'Hydrolyzed Collagen',
            'Unknown Protein',
    ...
    perfecting_prism: {
      name: 'Perfecting Prism',
      brand: 'Voir',
      buy_links: [
        {
          url: 'https://amzn.to/3Yv59El',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['pre-poo'],
      ...
      description:
        'Protects against fading, damage, and breakage while boosting shine and rebuilding the hair’s natural barrier',
      id: 'perfecting_prism',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 2,
          emollients_number: 8,
          simple_humectants: ['Glycerin', 'Panthenol', 'Caprylyl Glycol'],
          film_forming_humectants: [
            'Hydrolyzed keratin',
            'Aloe Barbadensis Leaf Extract',
          ],
    ...
    'hair_masque_&_scalp_detox': {
      name: 'Hair Masque & Scalp Detox',
      brand: 'Rhythm of The Rain',
      buy_links: [
        {
          url: 'https://amzn.to/3RLIwrC',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['treatments', 'deep_conditioners'],
      tags: ['samples', 'wavy', 'curly', 'coily', 'protein', 'glycerin-free'],
      ingredients_raw:
      ...
      description:
        'Deep conditions and restores locks to achieve a flake-free scalp and touchably softer hair.',
      id: 'hair_masque_&_scalp_detox',
      systems_excluded: [],
      status: 'caution',
      extensions: {
        frizzbot: {
    ...
    'nourish_+_restore_papaya_&_mango_deep_conditioning_mask': {
      name: 'Nourish + Restore Papaya & Mango Deep Conditioning Mask',
      brand: 'Rucker Roots',
      buy_links: [
        {
          url: 'https://amzn.to/4cWzzW2',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['deep_conditioners'],
      ...
      description:
        'An ultra-thick, deeply moisturizing mask that nourishes and restores dry, brittle hair from the root',
      id: 'nourish_+_restore_papaya_&_mango_deep_conditioning_mask',
      systems_excluded: [],
      status: 'warning',
      extensions: {
        frizzbot: {
    ...
    super_curl_moisture_cream: {
      name: 'Super Curl Moisture Cream',
      brand: "Uncle Funky's Daughter",
      buy_links: [
        {
          url: 'https://amzn.to/4jAmV1j',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['creams'],
      tags: ['samples', 'curly', 'coily', 'high_porosity', 'protein-free'],
      ingredients_raw:
      ...
      description:
        'Detangles tight textures, defines looser curls, and hydrates with almond oil, coconut oil, and shea butter',
      id: 'super_curl_moisture_cream',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 1,
          emollients_number: 7,
          simple_humectants: ['Glycerin', 'Honey', 'Caprylyl Glycol'],
          film_forming_humectants: ['Aloe Barbadensis Leaf Extract'],
          emollients: [
            'Coconut Oil',
            'Butyrospermum Parkii Shea Butter',
    ...
    curl_quenching_hair_butter: {
      name: 'Curl Quenching Hair Butter',
      brand: 'Fix My Curls',
      buy_links: [
        {
          url: 'https://amzn.to/4iJ8cQE',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['creams'],
      ...
      description:
        'A lightweight, vegan hair butter that delivers deep ongoing conditioning and protection',
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 2,
          emollients_number: 9,
          simple_humectants: ['Panthenol', 'Caprylyl Glycol', 'Glycerin'],
          film_forming_humectants: [
            'Flaxseed Extract',
    ...
    curl_defining_cream: {
      ...
      description:
        'A curl cream that defines texture without crunch, leaving curls bouncy, shiny, frizz-free, and weightless',
      id: 'curl_defining_cream',
      systems_excluded: [],
      status: 'warning',
      extensions: {
        frizzbot: {
    ...
    curl_talk_curl_cream: {
      name: 'Curl Talk Curl Cream',
      brand: 'Not Your Mothers',
      buy_links: [
        {
      ...
      description:
        'Defines curls, controls frizz, and adds shine for bouncy, polished curls',
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 2,
          emollients_number: 2,
          simple_humectants: ['Ethylhexylglycerin'],
          film_forming_humectants: ['Keratin', 'Hydroxyethylcellulose'],
          emollients: ['Butyrospermum Parkii Shea Butter', 'Unknown Polyquat'],
          score: -83,
        },
        porosity: {
          high: 100,
    ...
    hydrating_curl_cream: {
      ...
      description:
        'Defines, hydrates, and protects curls with hibiscus, mango butter, and marula oil',
      id: 'hydrating_curl_cream',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 4,
          emollients_number: 7,
          simple_humectants: ['Glycerin', 'Propanediol', 'Butylene glycol'],
          film_forming_humectants: [
            'Unknown Protein',
            'Glycine',
            'Unknown Protein',
    ...
    define_and_shine_gel: {
      name: 'Define and Shine Gel',
      brand: 'Inashi',
      buy_links: [
        {
          url: 'https://amzn.to/4iVjHEQ',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['gels'],
      ...
      description:
        'A frizz-fighting liquid gel to boost color retention, repair curls, and leave them soft, voluminous, and bouncy',
      id: 'define_and_shine_gel',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 3,
          emollients_number: 2,
          simple_humectants: ['Caprylyl Glycol'],
          film_forming_humectants: [
            'Unknown Protein',
            'Hydrolyzed Quinoa',
            'Hydroxyethylcellulose',
          ],
          emollients: ['Cetrimonium Chloride', 'Unknown Polyquat'],
          score: -90,
        },
        porosity: {
          high: 100,
    ...
    curl_talk_gel: {
      ...
      description:
        'A flexible-firm hold gel that defines curls, controls frizz, and adds strength with protein',
      id: 'curl_talk_gel',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 1,
          emollients_number: 3,
          simple_humectants: ['Glycerin', 'Propanediol', 'Ethylhexylglycerin'],
          film_forming_humectants: ['Keratin'],
          emollients: ['VP VA copolymer', 'Polyvinylpyrrolidone', 'Castor Oil'],
          score: -35,
        },
        porosity: {
          high: 74,
    ...
    'mane_magic_10-in-1_primer': {
      name: 'Mane Magic 10-in-1 Primer',
      brand: 'Eva NYC',
      buy_links: [
        {
          url: 'https://eva-nyc.com/products/mane-magic-10-in-1-primer?variant=40601010667587',
          retailer: 'Eva NYC',
        },
        {
          url: 'https://amzn.to/4jUzYum',
          retailer: 'Amazon',
        },
      ],
      ...
      ingredients_raw:
        'isododecane, isopropyl palmitate, isohexadecane, ethylhexyl olivate, argania spinosa argan kernel oil, helianthus annuus sunflower seed oil, squalane, fragrance',
      description:
        'Strengthens, protects from heat/UV/frizz, detangles, softens, adds shine, smooths, nourishes, and cuts drying time',
      id: 'mane_magic_10-in-1_primer',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
          ...
          simple_humectants: [],
          film_forming_humectants: [],
          emollients: ['Argan Oil', 'Sunflower Oil', 'Squalane'],
          score: -76,
        },
        porosity: {
          high: 37,
    ...
    'leave-in_conditioner_': {
      name: 'Leave-in Conditioner ',
      brand: 'The Vida Bars',
      buy_links: [
        {
          url: 'https://amzn.to/3Yv9N5f',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['leave_ins'],
      ...
      description:
        'A lightweight leave-in bar that strengthens, thickens, and boosts volume, shine, and curl definition',
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 1,
          emollients_number: 6,
          simple_humectants: ['Panthenol', 'Caprylyl Glycol'],
          film_forming_humectants: ['Unknown Protein'],
          emollients: [
            'Behentrimonium Methosulfate',
            'Cetearyl Alcohol',
    ...
    'perfect_repair_leave-in_treatment': {
      ...
      description:
        'A protein-packed leave-in foam that speeds up drying, protects against heat, fights frizz, and adds shine',
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants: ['Unknown Protein', 'Glutamic Acid'],
          emollients: [
            'Argan Oil',
            'Argan Oil',
            'Mangifera indica mango seed butter',
    ...
    reflex_styling_serum: {
      ...
      description:
        'Lightweight styling serum that enhances curl definition and elasticity with flexible hold, while hydrating and smoothing',
      ...
      extensions: {
        frizzbot: {
          ...
          emollients_number: 2,
          simple_humectants: ['Propylene Glycol', 'Caprylyl Glycol'],
          film_forming_humectants: ['Aloe Barbadensis Leaf Extract', 'Keratin'],
          emollients: ['Cetrimonium Chloride', 'Unknown Polyquat'],
          score: -77,
        },
        porosity: {
    ...
    the_puff_cuff: {
      ...
      tags: ['samples'],
      description:
        'A durable, damage-free hair clamp made for thick, curly hair that holds securely without pulling',
      id: 'the_puff_cuff',
      systems_excluded: [],
    },
    mint_satin_scrunchie: {
      name: 'Mint Satin Scrunchie',
      brand: 'Hairitage',
      buy_links: [
        {
      ...
      ingredients_raw: 'na',
      description:
        'This super-soft satin scrunchie is adorable paired with any outfit',
      id: 'mint_satin_scrunchie',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    'refresh_&_detangle_spray_': {
      name: 'Refresh & Detangle Spray ',
      brand: 'Rizos Curls',
      buy_links: [
        {
          url: 'https://amzn.to/3Z0PCfD',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['leave_ins', 'refreshers'],
      tags: [
        'samples',
        'wavy',
        'curly',
      ...
      description:
        'A refreshing detangling spray that revives curls between washes and smooths freshly washed hair',
      id: 'refresh_&_detangle_spray_',
      systems_excluded: [],
      status: 'warning',
      extensions: {
        frizzbot: {
    ...
    'leave-in_detangler': {
      ...
      description:
        'Softens curls, controls frizz on no-cleanse days, and makes detangling and styling easy for all curl types',
      id: 'leave-in_detangler',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    slip_detangler: {
      ...
      buy_links: [
        {
          url: 'https://curlkeeper.com/r?id=mg6h74',
          retailer: 'Curl Keeper',
        },
      ],
      product_categories: ['leave_ins'],
      ...
      description:
        'Loosens knots, conditions, and locks in color without buildup or dullness',
      id: 'slip_detangler',
      systems_excluded: [],
      status: 'ok',
      extensions: {
    ...
    swimmers_wellness_remedy: {
      name: 'Swimmers Wellness Remedy',
      brand: 'Malibu C',
      buy_links: [
        {
          url: 'https://amzn.to/4lXU5JR',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['treatments'],
      ...
      description:
        'Removes chlorine, copper, and pool buildup to restore shine, vibrancy, and health to hair',
      id: 'swimmers_wellness_remedy',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    swim_spritz_crystals: {
      name: 'Swim Spritz Crystals',
      brand: 'Malibu C',
      buy_links: [
        {
          url: 'https://amzn.to/4d5M2a2',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['treatments'],
      ...
      ingredients_raw:
        'ascorbic acid, citric acid, sodium citrate, disodium edta, sodium gluconate, sodium metabisulfite, potassium sorbate',
      description:
        'A post-swim essential with activated vitamin C that removes chlorine and its byproducts from hair to prevent damage',
      id: 'swim_spritz_crystals',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    a_walk_in_the_sun_luxury_hair_oil: {
      name: 'A Walk in The Sun Luxury Hair Oil',
      brand: 'Voir',
      buy_links: [
        {
          url: 'https://amzn.to/435bS9B',
          retailer: 'Amazon',
        },
      ],
      ...
      description:
        'A lightweight, hair oil that conditions without the grease, unlocks beachy waves, and uplifts your shine.',
    ...
    bonding_concentrate: {
      ...
      buy_links: [
        {
          url: 'https://www.sallybeauty.com/hair-care/shop-by-product/hair-styling-products/bonding-concentrate/SBS-009571.html?srsltid=AfmBOopGpW0Jafbx4NRyb8ZZ5gBnAXVPr_UZXg8I24G3bU0Ih-9PiC2k',
          retailer: 'Sally Beauty',
        },
      ],
      product_categories: ['oils'],
      ...
      description:
        'Boosts shine, tames flyaways, protects from heat, and hydrates with nourishing oils and bonding technology',
      id: 'bonding_concentrate',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
          ...
          emollients_number: 2,
          simple_humectants: [],
          film_forming_humectants: ['Hydroxypropylammonium Gluconate'],
          emollients: ['Argan Oil', 'Sunflower Oil'],
          score: -85,
        },
        porosity: {
          high: 83,
    ...
    maximum_thermal_primer: {
      name: 'Maximum Thermal Primer',
      brand: "Uncle Funky's Daughter",
      buy_links: [
        {
          url: 'https://amzn.to/3YssA16',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['leave_ins'],
      ...
      description:
        'This quick-drying formula protects your hair from heat while fortifying each strand for strength and resilience.',
      id: 'maximum_thermal_primer',
      systems_excluded: [],
      status: 'warning',
      extensions: {
        frizzbot: {
    ...
    butter_whip_styling_foam: {
      name: 'Butter Whip Styling Foam',
      brand: 'L’ANZA',
      buy_links: [
        {
          url: 'https://www.lanza.com/products/healing-curls-butter-whip-styling-foam?srsltid=AfmBOopsBvPm_Si28KlaQYnnFPBuVhvsd6kbiig3ikpT7qJY8Whsp7B3&clearforme=true',
          retailer: "L'Anza",
        },
      ],
      product_categories: ['foams'],
      ...
      description:
        'A lightweight mousse that defines curls and waves with flexible hold and adds brilliant shine',
    ...
    bonding_primer: {
      ...
      buy_links: [
        {
          url: 'https://www.sallybeauty.com/hair-care/shop-by-product/hair-treatments/bonding-primer/SBS-009616.html?srsltid=AfmBOoryDxKxZyLmmEfvmC-r2Yg2yDQ8QZa5DgWa6wsfXRepF-quxEVJ',
          retailer: 'Sally',
        },
      ],
      product_categories: ['pre-poo'],
      ...
      description:
        'Instantly helps repair hair, smooth strands and reduce breakage after just one use. Designed to be used with Bonding Pre-Shampoo. ',
      id: 'bonding_primer',
      systems_excluded: [],
      status: 'ok',
      extensions: {
    ...
    'no._10_bond_shaper_gel': {
      name: 'No. 10 Bond Shaper Gel',
      brand: 'Olaplex',
      buy_links: [
        {
      ...
      description:
        'A humidity-resistant gel with flexible hold that fights frizz, hydrates, and strengthens curl bonds',
      id: 'no._10_bond_shaper_gel',
      systems_excluded: [],
      status: 'warning',
      extensions: {
        frizzbot: {
    ...
    'no._9_bond_protector_nourishing_hair_serum': {
      ...
      description:
        'Shields hair from pollution and protects against heat damage while adding satin shine and reducing static and tangles',
      id: 'no._9_bond_protector_nourishing_hair_serum',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    'no._7_bonding_oil': {
      ...
      description:
        'Lightweight oil that adds shine, reduces breakage, controls frizz for 72 hours, and protects against heat up to 450°F',
      id: 'no._7_bonding_oil',
      systems_excluded: [],
      status: 'warning',
      extensions: {
        frizzbot: {
    ...
    'no._3_hair_perfector': {
      ...
      description:
        'A pre-shampoo treatment to repair and strengthen hair from the inside out',
      id: 'no._3_hair_perfector',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    scalp_scrub_exfoliating_scalp_treatment: {
      name: 'Scalp Scrub Exfoliating Scalp Treatment',
      brand: 'Umberto Giannini',
      buy_links: [
        {
          url: 'https://us.umbertogiannini.com/products/scalp-starter-kit',
          retailer: 'Umberto Giannini',
          countries: ['US', 'UK', 'EU'],
        },
      ],
      product_categories: ['treatments'],
      ...
      description:
        'A natural exfoliating treatment that removes dead skin and excess oil to prevent flakes and restore a healthy scalp',
      id: 'scalp_scrub_exfoliating_scalp_treatment',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    argan_oil_repairing_deep_conditioner: {
      name: 'Argan Oil Repairing Deep Conditioner',
      brand: 'Hask',
      buy_links: [
        {
          url: 'https://amzn.to/4j4FdqN',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['deep_conditioners'],
      ...
      description:
        'Strengthening, hydrating treatment that will repair the look of dry, damaged and over-processed hair',
      id: 'argan_oil_repairing_deep_conditioner',
      systems_excluded: [],
      status: 'warning',
      extensions: {
        frizzbot: {
    ...
    hydrating_deep_conditioner: {
      name: 'Hydrating Deep Conditioner',
      brand: 'Fix My Curls',
      buy_links: [
        {
          url: 'https://amzn.to/4m0GqSi',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['deep_conditioners'],
      ...
      description:
        'This protein heavy deep conditioner is just as strengthening as it is moisturizing.',
      id: 'hydrating_deep_conditioner',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    cleansing_shampoo: {
      ...
      description:
        'A mild shampoo that rids your scalp of buildup without stripping it of any natural oils',
      id: 'cleansing_shampoo',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    hydration_shampoo: {
      ...
      buy_links: [
        {
          url: 'https://rahua.com/products/hydration-shampoo',
          retailer: 'Rahua',
        },
        {
          url: 'https://amzn.to/3RGn6vY',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['shampoos'],
      ...
      description:
        'Replenishes dry, thirsty hair with a medium cleanse and a touch of protein for added bounce',
      id: 'hydration_shampoo',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 4,
          emollients_number: 2,
          simple_humectants: ['Glycerin', 'Lactic Acid'],
          film_forming_humectants: [
            'Aloe Barbadensis Leaf Extract',
            'Hydrolyzed Quinoa',
            'Hydroxyethylcellulose',
          ...
          emollients: ['Xanthan Gum', 'Guar Hydroxypropyltrimonium Chloride'],
          score: -86,
        },
        porosity: {
          high: 86,
    ...
    hydration_conditioner: {
      ...
      description:
        'A rich formula infused with Amazonian oils and protein-bonding sugars to hydrate and replenish the thirstiest hair',
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 3,
          emollients_number: 5,
          simple_humectants: ['Glycerin', 'Molasses', 'Panthenol'],
          film_forming_humectants: [
            'Aloe Barbadensis Leaf Extract',
            'Hydrolyzed Quinoa',
            'Glycine',
    ...
    hydration_mask: {
      ...
      description:
        'Amazonian oils and protein-bonding sugars that deliver deep hydration for revitalized, shiny, and smooth hair',
      id: 'hydration_mask',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
          ...
          emollients_number: 5,
          simple_humectants: ['Glycerin'],
          film_forming_humectants: ['Glycine', 'Hydrolyzed Quinoa'],
          emollients: [
            'Sunflower Oil',
            'Behentrimonium Methosulfate',
            'Cetearyl Alcohol',
    ...
    aloe_vera_hair_gel: {
      ...
      description:
        'A soft hold, protein free hair gel that shapes strands; infusing hair with nutrients to promote optimal health',
      id: 'aloe_vera_hair_gel',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    omega_9_hair_mask: {
      ...
      description:
        'Moisture and low protein penetrate deeply to strengthen, soften, and hydrate hair from root to tip',
      id: 'omega_9_hair_mask',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
          ...
          emollients_number: 2,
          simple_humectants: ['Glycerin', 'Panthenol'],
          film_forming_humectants: ['Hydrolyzed Quinoa', 'Glycine'],
          emollients: ['Sunflower Oil', 'Butyrospermum Parkii Shea Butter'],
          score: -66,
        },
        porosity: {
          high: 41,
    ...
    sahascalp_cooling_scalp_mud_mask: {
      name: 'SahaScalp Cooling Scalp Mud Mask',
      brand: 'Sable & Mane',
      buy_links: [
        {
          url: 'https://amzn.to/4lZAWaF',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['treatments'],
      ...
      description:
        'A post-shampoo scalp mask with Sea Silt to purify, Neem/Menthol to soothe, and Apricot Oil to soften and add shine',
    ...
    super_moisture_shampoo: {
      ...
      description:
        'A gentle sulfate-free shampoo to nourish and hydrate your strands with a small touch of protein',
      id: 'super_moisture_shampoo',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants: ['Unknown Protein', 'Unknown Protein'],
          emollients: [
            'Marula Oil',
            'Astrocaryum Murumuru Seed Butter',
            'Olive Oil',
    ...
    hard_water_wellness_remedy: {
      name: 'Hard Water Wellness Remedy',
      brand: 'Malibu C',
      buy_links: [
        {
          url: 'https://amzn.to/3Sjqa1f',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['treatments'],
      ...
      description:
        'Remove hard water buildup to restore shine and softness to hair with this chelating treatment',
      id: 'hard_water_wellness_remedy',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    opp_one_pass_press_heat_protectant_spray: {
      ...
      id: 'opp_one_pass_press_heat_protectant_spray',
      systems_excluded: [],
      status: 'caution',
      extensions: {
        frizzbot: {
          ...
          emollients: ['Unknown Polyquat', 'Jojoba Oil'],
          score: -86,
        },
        porosity: {
          high: 100,
    ...
    super_moisture_conditioner: {
      name: 'Super Moisture Conditioner',
      brand: 'California Naturals',
      buy_links: [
        {
          url: 'https://amzn.to/4d2t58e',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['conditioners'],
      ...
      description:
        'Super moisturizing, protein-free conditioner is fantastic for erasing frizz and defending from split ends!',
      id: 'super_moisture_conditioner',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 1,
          emollients_number: 11,
          simple_humectants: ['Panthenol', 'Ethylhexylglycerin', 'Lactic Acid'],
          film_forming_humectants: ['Aloe Barbadensis Leaf Extract'],
          emollients: [
            'Stearyl Alcohol',
            'Cetyl Alcohol',
    ...
    'define_&_shine_mango_papaya_curl_defining_custard_styling_gel': {
      ...
      buy_links: [
        {
          url: 'https://amzn.to/4d7cnEQ',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['custards'],
      tags: ['samples', 'wavy', 'curly', 'coily', 'protein', 'glycerin-free'],
      ingredients_raw:
        'aqua purified water, vp va copolymer, hydroxyethylcellulose, hydrolyzed oat protein, persea gratissima avocado oil, helianthus annuus sunflower seed oil, panthenol-dl pro vitamin b5, capryl gycol, phenoxyethanol, sorbic acid, coumarin, limonene',
      description:
        'A protein-rich, strong-hold styling gel that defines curls and delivers intense shine',
      id: 'define_&_shine_mango_papaya_curl_defining_custard_styling_gel',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
          ...
          emollients: ['VP VA copolymer', 'Avocado Oil', 'Sunflower Oil'],
          score: -84,
        },
        porosity: {
          high: 81,
    ...
    pamper_my_curls_curl_sculpting_glaze_strong_hold_gel: {
      name: 'Pamper My Curls Curl Sculpting Glaze Strong Hold Gel',
      brand: 'Inahsi',
      buy_links: [
        {
          url: 'https://amzn.to/42TC1bb',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['gels'],
      ...
      description:
        'A protein-free strong-hold glaze that defines curls, fights frizz, adds shine, and holds styles without white residue',
      id: 'pamper_my_curls_curl_sculpting_glaze_strong_hold_gel',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    holiroots_hair_mask: {
      ...
      description:
        'A rich and moisturizing deep treatment / hair mask that is designed to restore hydration, add shine and smooth frizz',
      id: 'holiroots_hair_mask',
      systems_excluded: [],
      status: 'caution',
      extensions: {
        frizzbot: {
    ...
    'fable_&_mane_sahascalp_wild_ginger_purifying_scrub': {
      name: 'Fable & Mane SahaScalp Wild Ginger Purifying Scrub',
      brand: 'Fable & Mane',
      buy_links: [
        {
          url: 'https://amzn.to/42Way8S',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['treatments'],
      ...
      description:
        'A protein-rich exfoliating shampoo to boost circulation, reduce buildup, and gently remove flakiness',
      id: 'fable_&_mane_sahascalp_wild_ginger_purifying_scrub',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    'curl_wow_flo-etry_vital_natural_serum': {
      name: 'Curl Wow Flo-etry Vital Natural Serum',
      brand: 'Color Wow ',
      buy_links: [
        {
          url: 'https://amzn.to/3S8puMl',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['leave_ins'],
      ...
      description:
        'A lightweight curl primer that delivers deep conditioning without buildup to leave hair feeling product-free',
    ...
    set_gel_to_foam_styling_mousse: {
      ...
      description:
        'A gel-to-foam with medium hold that adds definition and volume while leaving curls soft, touchable, and healthy-looking',
      id: 'set_gel_to_foam_styling_mousse',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
          ...
          emollients: ['Unknown Polyquat', 'Polyvinylpyrrolidone'],
          score: -85,
        },
        porosity: {
          high: 100,
    ...
    'tropical_oasis_anti-humidity_firm_hold_hair_gel': {
      ...
      tags: ['samples', 'wavy', 'curly', 'coily', 'protein'],
      ingredients_raw:
        'distilled water, fresh pineapple juice extract, aloe vera juice, glycerin, maltodextrin vp copolymer, gluconodeltalactone, sodium benzoate, hydoxyethycelluolose, hydrolyzed quinoa protein, phthalate-free fragrance',
      description:
        'A frizz-fighting lightweight gel perfect for protecting against humidity',
      ...
      extensions: {
        frizzbot: {
          ...
          emollients: ['Maltodextrin VP Copolymer'],
          score: -79,
        },
        porosity: {
          high: 93,
    ...
    sculpt_curl_defining_gel: {
      ...
      product_categories: ['gels'],
      tags: ['samples', 'wavy', 'curly', 'coily', 'high_porosity', 'protein'],
      ingredients_raw:
      ...
      description:
        'A strong-hold gel that provides hold, definition, and shine for curls and coils.',
      ...
      extensions: {
        frizzbot: {
          ...
          emollients: ['Xanthan Gum', 'Jojoba Oil'],
          score: -87,
        },
        porosity: {
          high: 92,
    ...
    bounce_styling_cream: {
      ...
      description:
        'A versatile styling cream that delivers bouncy, defined, shiny, and hydrated hairstyles in one step.',
    ...
    boost_hydrate_and_refresh_spray: {
      ...
      description:
        'A refresher spray that instantly revives hairstyles needing extra conditioning between wash days.',
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 3,
          emollients_number: 6,
          simple_humectants: ['Propanediol', 'Caprylyl Glycol', 'Panthenol'],
          film_forming_humectants: [
            'Aloe Barbadensis Leaf Extract',
            'Glycine',
            'Unknown Protein',
    ...
    'olaplex_no._10_bond_shaper_curl_defining_gel': {
      ...
      description:
        'Humidity-resistant curl gel that defines natural curl patterns with flexible hold, frizz control, and bond-building tech',
    ...
    wavetech_wave_foam: {
      ...
      description:
        'A styling foam designed to create soft, defined waves without the crunch for the perfect natural-wavy look',
    ...
    healing_moisture_moi_moi_hair_masque: {
      ...
      description:
        'A rich, hydrating masque to restore extremely dry, brittle hair.',
    ...
    neem_plant_silk_serum: {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants: ['Keratin', 'Pectin'],
          emollients: [
            'Cyclopentasiloxane',
            'Dimethicone',
            'Unknown Non-Water Soluble Silicone',
    ...
    mousse_def_texture_foam: {
      ...
      description:
        'A light to medium-hold mousse that is great for all wave and curl types',
    ...
    'rice_pudding_leave-in_conditioner_and_moisturizer': {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 1,
          emollients_number: 1,
          simple_humectants: ['Sodium PCA', 'Panthenol'],
          film_forming_humectants: ['Marshmallow root Extract'],
          emollients: ['Cetearyl Alcohol'],
          score: -75,
        },
        porosity: {
    ...
    'sweet_spirit_leave-in_conditioner': {
      ...
      product_categories: ['leave_ins'],
      tags: ['high_porosity', 'normal_porosity', 'featured', 'protein'],
      cost: 2.8,
      asin: 'B004KM1OEK',
      ingredients_raw:
    ...
    'hydrate_&_plump_leave-in_conditioner': {
      ...
      brand: 'Curlsmith',
      product_categories: ['leave_ins'],
      tags: ['normal_porosity', 'high_porosity', 'featured', 'protein-free'],
      ingredients_raw:
      ...
      asin: 'B0CZVVB2C9',
      description:
        "This has a small amount of isopropyl alcohol, which we mark as caution, but as it's towards the end of the ingredients list so it's unlikely to be harmful for hair.",
      cost: 1.9,
    ...
    direct_leave_in_weightless_moisture_conditioner: {
      name: 'Direct Leave In Weightless Moisture Conditioner',
      brand: 'Giovanni',
      product_categories: ['leave_ins'],
      tags: [
        'normal_porosity',
    ...
    'soft_leave-in_cream': {
      ...
      description:
        'A lightweight leave-in that prevents your hair from getting dry',
      buy_links: [
        {
    ...
    moonshine_hair_and_body_oil: {
      ...
      ingredients_raw:
        'jojoba oil, avocado oil, sweet almond oil, argan oil, castor oil, lemongrass essential oil, cinnamon essential oil, sweet orange essential oil, ginger essential oil, caprylhydroxamic gg',
      buy_links: [
        {
    ...
    hush_nourishing_oil: {
      ...
      ingredients_raw:
        'helianthus annuus sunflower seed oil, oenothera biennis evening primrose oil, vitis vinifera grape seed oil, simmondsia chinensis jojoba seed oil, backhousia citriodora lemon myrtle leaf oil, tocopheryl acetate, rosa canina rosehip fruit oil, macadamia ternifolia seed oil',
      cost: 13,
      ...
      extensions: {
        frizzbot: {
          ...
          simple_humectants: [],
          film_forming_humectants: [],
          emollients: ['Sunflower Oil', 'Grapeseed Oil', 'Jojoba Oil'],
          score: -76,
        },
        porosity: {
          high: 25,
    ...
    bonding_oil: {
      ...
      extensions: {
        frizzbot: {
          ...
          emollients_number: 5,
          simple_humectants: [],
          film_forming_humectants: ['Cicer Arietinum Seed Extract'],
          emollients: [
            'Olive Oil',
            'Butyrospermum Parkii Shea Butter',
            'Castor Oil',
    ...
    '100%_plant-derived_squalane': {
      ...
      brand: 'The Ordinary',
      product_categories: ['oils', 'pre-poo'],
      tags: ['featured', 'protein-free', 'glycerin-free'],
    ...
    doux_drops: {
      ...
      buy_links: [
        {
          url: 'https://thedoux.com/products/doux-drops-bonding-polish-spray',
          retailer: 'The Doux',
        },
        {
      ...
      ingredients_raw:
        'dimethicone, c13-14 isoalkane formerly c13-14 isoparaffin, adansonia digitata seed oil, simmondsia chinensis jojoba seed oil, brassica campestris aleurites fordi oil copolymer, fragrance, isopropyl myristate, tocopheryl acetate, green 6 ci 61565',
      description:
        'A shine-boosting, bond-building serum that strengthens hair, smooths the cuticle, and protects against breakage',
      id: 'doux_drops',
      systems_excluded: [],
      status: 'warning',
      extensions: {
        frizzbot: {
          ...
          simple_humectants: [],
          film_forming_humectants: [],
          emollients: ['Dimethicone', 'Paraffin Wax', 'Jojoba Oil'],
          score: -76,
        },
        porosity: {
          high: 51,
    ...
    glow_repair_hair_glaze: {
      ...
      description:
        'A lightweight serum that shields hair from environmental damage while leaving it soft, smooth, and brilliantly shiny.',
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 1,
          emollients_number: 3,
          simple_humectants: ['Propylene Glycol'],
          film_forming_humectants: ['Glycine'],
          emollients: ['Lauryl Alcohol', 'Castor Oil', 'Sunflower Oil'],
          score: -81,
        },
        porosity: {
          high: 63,
    ...
    'bond_curl_rehab_salve,_bond_building_strength_treatment_for_weak,_damaged_hair':
      {
        ...
        product_categories: ['pre-poo', 'treatments'],
        tags: [
          'samples',
          'wavy',
          'curly',
        ...
        description:
          'A protein-rich bond-building treatment that targets all 3 hair bonds to repair, strengthen, and reduce damage—formulated specifically for curls',
        ...
        extensions: {
          frizzbot: {
            ...
            film_forming_humectants_number: 3,
            emollients_number: 7,
            simple_humectants: ['Ethylhexylglycerin', 'Glycerin'],
            film_forming_humectants: [
              'Salvia hispanica chia seed extract',
              'Creatine',
              'Hydroxypropylammonium Gluconate',
    ...
    sangria_hair_refresher: {
      name: 'Sangria Hair Refresher',
      brand: 'Ecoslay',
      ingredients_raw:
        'purified water, aloe barbadensis leaf juice, vaccinium angustifolium fruit water, prunus cerasus fruit water, hhydrolyzed silk protein, sodium pca, lactobacillus ferment, lactobacillus, cocos nucifera fruit extract, amaranthus caudatus seed extract, equisetum arvense extract, panthenol, cinnamidopropyltrimonium chloride, sodium gluconate',
      product_categories: ['refreshers'],
      tags: [
        'normal_porosity',
        'high_porosity',
    ...
    'pamper_my_curls_all-in-one_moisture_mist': {
      name: 'Pamper My Curls All-in-One Moisture Mist',
      brand: 'Inashi',
      buy_links: [
        {
          url: 'https://amzn.to/4iHnxRu',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['leave_ins', 'sprays', 'refreshers'],
      tags: ['samples', 'wavy', 'curly', 'coily', 'low_porosity', 'protein'],
      ingredients_raw:
      ...
      description:
        'A lightweight, oil-free mist that moisturizes and refreshes curls without weighing them down',
    ...
    chai_latte_hair_cleanser: {
      name: 'Chai Latte Hair Cleanser',
      brand: 'Ecoslay',
      ingredients_raw:
        'water, sodium methyl cocoyl taurate, sodium lauroyl sarcosinate, stearamidopropyl dimethylamine, black tea extract, slippery elm extract, sodium pca, propanediol, panthenol, peppermint oil, melissa leaf extract, nettle leaf extract, horsetail leaf extract, peppermint leaf extract, hydroxypropyl starch phosphate, sage extract, yucca leaf extract, burdock root extract, citric acid, lexfeel wow-a, vanilla planifolia fruit oil, ginger root oil, cinnamon leaf oil, clove flower oil, caprylhydroxamic acid gg',
      product_categories: ['shampoos'],
      tags: [
        'normal_porosity',
        'featured',
      ...
      description:
        'This gentle, botanical-rich shampoo is handmade in Georgia and has a delicious chai latte scent.',
      buy_links: [
        {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 0,
          emollients_number: 1,
          simple_humectants: ['Sodium PCA', 'Propanediol', 'Panthenol'],
          film_forming_humectants: [],
          emollients: ['Stearamidopropyl Dimethylamine'],
          score: -6,
        },
        porosity: {
          high: 100,
    ...
    'vitalcurl+_clear_&_gentle_shampoo': {
      ...
      extensions: {
        frizzbot: {
          ...
          simple_humectants: ['Glycerin', 'Panthenol'],
          film_forming_humectants: [],
          emollients: ['Sunflower Oil', 'Unknown Polyquat'],
          score: -15,
        },
        porosity: {
          high: 65,
    ...
    curl_shampoo: {
      ...
      systems_excluded: ['curly_default'],
      product_categories: ['shampoos'],
      tags: ['normal_porosity', 'low_porosity', 'protein', 'glycerin-free'],
      cost: 0.66,
      ingredients_raw:
    ...
    hydrating_hairbath: {
      ...
      extensions: {
        frizzbot: {
          ...
          emollients_number: 4,
          simple_humectants: ['Glycerin'],
          film_forming_humectants: ['Hydrolyzed Quinoa', 'Unknown Protein'],
          emollients: [
            'Guar Hydroxypropyltrimonium Chloride',
            'Jojoba Oil',
            'Butyrospermum Parkii Shea Butter',
    ...
    gentle_shampoo: {
      ...
      brand: 'Tootilab',
      product_categories: ['shampoos'],
      tags: ['featured', 'women-owned', 'low_ph', 'protein-free'],
      ingredients_raw:
        'water aqua, cocamidopropyl betaine, lauryl glucoside, glycerin, sodium methyl cocoyl taurate, aloe barbadensis leaf juice powder, caprylyl capryl glucoside, sodium lauroyl sarcosinate, sodium cocoamphoacetate, inulin, fragrance parfum, benzyl alcohol, polyquaternium-7, potassium sorbate, saccharide isomerate, argan oil glycereth-8 esters, guar hydroxypropyltrimonium chloride, citric acid, sodium chloride, alpha-glucan oligosaccharide, trisodium ethylenediamine disuccinate, tocopherol, helianthus annuus sunflower seed oil, sodium citrate, hexyl cinnamal',
      description:
        'A gentle shampoo with lots of slip and a low pH (which helps prevent frizz).',
      buy_links: [
        {
    ...
    pure_harmony_hairbath: {
      ...
      cost: 2.25,
      product_categories: ['shampoos'],
      tags: ['low_porosity', 'normal_porosity', 'protein'],
      asin: 'B074Q2CNMY',
    ...
    clarity_hairbath: {
      ...
      product_categories: ['shampoos'],
      tags: ['low_porosity', 'normal_porosity', 'protein-free'],
      asin: 'B0BHD3JKTL',
      cost: 6,
      id: 'clarity_hairbath',
      systems_excluded: [],
    ...
    'nourish_&_flourish_shampoo': {
      ...
      extensions: {
        frizzbot: {
          ...
          simple_humectants: ['Glycerin', 'Propanediol'],
          film_forming_humectants: ['Unknown Protein'],
          emollients: ['Guar Hydroxypropyltrimonium Chloride'],
          score: -20,
        },
        porosity: {
          high: 100,
    ...
    essential_moisture_cleanser: {
      ...
      brand: 'Curlsmith',
      product_categories: ['shampoos'],
      tags: ['high_porosity', 'normal_porosity', 'featured', 'protein-free'],
      ingredients_raw:
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 1,
          emollients_number: 3,
          simple_humectants: ['Glucose', 'Propanediol', 'Glycerin'],
          film_forming_humectants: ['Aloe Barbadensis Leaf Extract'],
          emollients: [
            'Sunflower Oil',
            'Guar Hydroxypropyltrimonium Chloride',
    ...
    curl_definition_shampoo: {
      name: 'Curl Definition Shampoo',
      brand: 'Not Your Mothers Naturals',
      ingredients_raw:
        'water aqua eau, sodium cocoyl isethionate, sodium lauroyl methyl isethionate, cocamidopropyl hydroxysultaine, peg-120 methyl glucose dioleate, glycol distearate, polyquaternium-10, quaternium-80, mangifera indica mango seed butter, gardenia tahitensis flower extract, glycerin, tetrasodium glutamate diacetate, fragrance parfum, linalool, hexyl cinnamal, coumarin, phenoxyethanol, ethylhexylglycerin, citric acid',
      product_categories: ['shampoos'],
      tags: ['high porosity', 'low porosity', 'protein'],
      cost: 0.5,
      buy_links: [
        {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 1,
          emollients_number: 2,
          simple_humectants: ['Glucose', 'Glycerin', 'Ethylhexylglycerin'],
          film_forming_humectants: ['Sodium Glutamate'],
          emollients: [
            'Unknown Polyquat',
            'Mangifera indica mango seed butter',
    ...
    energizing_shampoo: {
      ...
      description:
        'This shampoo has a low pH, which helps to keep the hair cuticle closed and prevent moisture loss.',
      ingredients_raw:
        'water eau, coco-glucoside, sodium chloride himalayan crystal salt, sodium c14-16 olefin sulfonate, disodium laureth sulfosuccinate, lauramide dea, panthenoil, polysorbate 80, silk amino acides, hydroxyproyl methylcellulose, citric acid, fragrance, dmdm hydantoin',
    ...
    'smooth_as_silk™_deep_moisture_shampoo': {
      ...
      description:
        'An excellent low-pH (~5 protects against frizz) shampoo at a great price.',
      ingredients_raw:
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 1,
          emollients_number: 1,
          simple_humectants: ['Glycerin', 'Urea', 'Panthenol'],
          film_forming_humectants: ['Aloe Barbadensis Leaf Extract'],
          emollients: ['Xanthan Gum'],
          score: -33,
        },
    ...
    'sulphate_4%_cleanser_for_body_and_hair': {
      ...
      extensions: {
        frizzbot: {
          ...
          simple_humectants: ['Ethylhexylglycerin'],
          film_forming_humectants: [],
          emollients: ['Xanthan Gum', 'Benzyl Alcohol'],
          score: -56,
        },
        porosity: {
          high: 70,
    ...
    outta_my_hair_gentle_daily_shampoo: {
      ...
      brand: 'Hairitage',
      product_categories: ['shampoos'],
      tags: ['wavy', 'curly', 'samples', 'bonding', 'protein-free'],
      ingredients_raw:
      ...
      description:
        'This shampoo cleanses impurities and excess oils without stripping hair',
      buy_links: [
        {
      ...
      id: 'outta_my_hair_gentle_daily_shampoo',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    cleansed_moisturizing_shampoo: {
      name: 'Cleansed Moisturizing Shampoo',
      brand: 'Miche',
      product_categories: ['shampoos'],
      tags: [
        'wavy',
      ...
      description:
        'A sulfate-free, pH-balanced shampoo that moisturizes, restores dry hair, and stimulates the scalp',
      buy_links: [
        {
      ...
      id: 'cleansed_moisturizing_shampoo',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 0,
          emollients_number: 1,
          simple_humectants: ['Glycerin', 'Caprylyl Glycol'],
          film_forming_humectants: [],
          emollients: ['Guar Hydroxypropyltrimonium Chloride'],
          score: -2,
        },
    ...
    curl_liberating_shampoo: {
      name: 'Curl Liberating Shampoo',
      brand: 'Imbue',
      product_categories: ['shampoos'],
      tags: ['curly', 'coily', 'samples', 'protein-free'],
      ingredients_raw:
      ...
      description:
        'A sulfate-free shampoo that removes buildup without stripping, leaving curls soft, shiny, and defined',
      buy_links: [
        {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 0,
          emollients_number: 5,
          simple_humectants: ['Glucose', 'Glycerin', 'Panthenol'],
          film_forming_humectants: [],
          emollients: [
            'Unknown Polyquat',
            'Butyrospermum Parkii Shea Butter',
    ...
    'sunrise_rituals:_signature_shampoo': {
      name: 'Sunrise Rituals: Signature Shampoo',
      brand: 'Voir',
      buy_links: [
        {
          url: 'https://amzn.to/3GQ7gfO',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['shampoos'],
      ...
      description:
        'A daily go-to shampoo infused with hyaluronic and lactic acids that gently cleanses while boosting smoothness and shine',
      id: 'sunrise_rituals:_signature_shampoo',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    big_energy_volumizing_shampoo: {
      name: 'Big Energy Volumizing Shampoo',
      brand: 'Curl Keeper',
      buy_links: [
        {
          url: 'https://curlkeeper.com/r?id=ttmupk',
          retailer: 'Curl Keeper',
        },
      ],
      product_categories: ['shampoos'],
      ...
      ingredients_raw:
        'water eau, coco-glucoside, sodium chloride himalayan crystal salt, sodium c14-16 olefin sulfonate, disodium laureth sulfosuccinate, lauramide dea, panthenoil, polysorbate 80, silk amino acides, hydroxyproyl methylcellulose, citric acid, fragrance, dmdm hydantoin',
      description:
        'Cleanses and stimulates your scalp, giving you the perfect foundation for voluminous curls.',
      id: 'big_energy_volumizing_shampoo',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
    ...
    scalp_revitalizing_solution_hair_thickening_shampoo: {
      name: 'Scalp Revitalizing Solution Hair Thickening Shampoo',
      brand: 'Dr. Groot',
      buy_links: [
        {
          url: 'https://lgbeauty.com/products/dr-groot-scalp-revitalizing-solution-hair-thickening-shampoo',
          retailer: 'LG Beauty',
        },
        {
          url: 'https://amzn.to/3GAgpJD',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['shampoos'],
      ...
      description:
        'With probiotic beads, biotin, rosemary, and caffeine to support scalp health and promote stronger, healthier hair growth',
      ...
      extensions: {
        frizzbot: {
          ...
          emollients: ['Benzyl Alcohol', 'Unknown Polyquat'],
          score: -41,
        },
        porosity: {
          high: 82,
    ...
    'no._4_bond_maintenance_shampoo': {
      name: 'No. 4 Bond Maintenance Shampoo',
      brand: 'Olaplex',
      buy_links: [
        {
          url: 'https://olaplex.com/products/olaplex-n-4-bond-maintenance-shampoo-us',
          retailer: 'Olaplex',
        },
        {
          url: 'https://www.lookfantastic.com/p/olaplex-no.4-fine-bond-maintenance-shampoo-250ml/16162873/',
          retailer: 'Olaplex',
          countries: ['UK', 'EU'],
        },
        {
      ...
      ingredients_raw:
        'water aqua eau, sodium lauroyl methyl isethionate, cocamidopropyl hydroxysultaine, potassium cocoyl glycinate, disodium cocoyl glutamate, sodium lauroyl sarcosinate, potassium cocoate, decyl glucoside, glycereth-26, bis-aminopropyl diglycol dimaleate, cocamidopropylamine oxide, disodium laureth sulfosuccinate, glycol distearate, sodium cocoyl glutamate, methyl gluceth-20, acrylates copolymer, peg-120 methyl glucose dioleate, amodimethicone, citric acid, sodium lauryl sulfoacetate, polyquaternium-10, ethylhexylglycerin, divinyldimethicone dimethicone copolymer, polyquaternium-11, trisodium ethylenediamine disuccinate, guar hydroxypropyltrimonium chloride, c11-15 pareth-7, laureth-9, glycerin, trideceth-12, c12-13 pareth-23, c12-13 pareth-3, hydrolyzed vegetable protein, pg-propyl silanetriol, panthenol, acetic acid, tetrasodium edta, pentasodium triphosphate, sodium hydroxide, disodium edta, helianthus annus sunflower seed oil, tocopherol, prunus armeniaca apricot kernel oil, pseudozyma epicola camellia sinensis seed oil ferment extract filtrate, pseudozyma epicola argania spinosa kernel oil ferment filtrate, quaternium-95, propanediol, helianthus annus sunflower seed extract, peg-8, euterpe oleracea fruit extract, punica granatum extract, rosemarinus officinalis rosemary leaf extract, musa sapientum banana fruit extract, origanum vulgare lear extract, morinda citrifolia fruit extract, articum lappa root extract, peg-8 smdi copolymer, sodium hyaluronate, palmitoyl myristyl serinate, sodium polyacrylate, pentaerythrityl tetra-di-t-butyl hydroxyhydrocinnamate, biotin, benzoic acid, phenoxyethanol, chlorphenesin, potassium sorbate, sodium benzoate, fragrance parfum, citral, hexyl cinnamal, limonene',
      description:
        'Uses Olaplex’s bonding technology to gently cleanse, strengthen, and add shine while repairing damage',
    ...
    hair_spray: {
      ...
      description:
        'A lightweight spray that helps set your style in place and resist humidity',
      buy_links: [
        {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 1,
          emollients_number: 1,
          simple_humectants: ['Panthenol', 'Propanediol', 'Caprylyl Glycol'],
          film_forming_humectants: ['Aloe Barbadensis Leaf Extract'],
          emollients: ['Copolymer'],
          score: -48,
        },
    ...
    spray_gel: {
      ...
      buy_links: [
        {
          url: 'https://curlkeeper.com/r?id=9a986t',
          retailer: 'Curl Keeper',
        },
      ],
      product_categories: ['gels', 'sprays'],
      tags: [
        'samples',
        'wavy',
        'curly',
      ...
      ingredients_raw:
        'water aqua eau, vp va copolymer, propylene glycol, glycerin, panthenol, oleth-20, carbomer, triethanolamine, polyquaternium-11, parfum, benzyl alcohol, caprylyl glycol, benzoic acid, amyl cinnamal, geraniol, linalool',
      description:
        'Spray gel that delivers the hold of a gel with added definition, volume, and shine—made with gentle, natural ingredients',
      id: 'spray_gel',
      systems_excluded: [],
      status: 'ok',
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants: [],
          emollients: ['VP VA copolymer', 'Unknown Polyquat', 'Benzyl Alcohol'],
          score: -14,
        },
        porosity: {
          high: 100,
    ...
    matcha_boost_protein_strengthening_treatment: {
      name: 'Matcha Boost Protein Strengthening Treatment',
      brand: 'Ecoslay',
      product_categories: ['treatments'],
      tags: [
        'normal_porosity',
      ...
      ingredients_raw:
        'distilled water, ceteryl alcohol, behentrimonium methosulfate, hydrolyzed quinoa protein, hydrolyzed keratin protein, matcha extract, propanediol, hp starch, caprylhydroxamic acid gg preservation blend caprylhydroxamic acid, glyceryl',
      buy_links: [
        {
      ...
      extensions: {
        frizzbot: {
          ...
          emollients_number: 2,
          simple_humectants: ['Propanediol'],
          film_forming_humectants: ['Hydrolyzed Quinoa', 'Hydrolyzed keratin'],
          emollients: ['Cetearyl Alcohol', 'Behentrimonium Methosulfate'],
          score: -82,
        },
        porosity: {
          high: 100,
    ...
    'multi-peptide_serum_for_hair_density': {
      ...
      extensions: {
        frizzbot: {
          ...
          emollients: ['Xanthan Gum', 'Castor Oil'],
          score: -35,
        },
        porosity: {
          high: 57,
    ...
    scalp_balancing_sake_rinse: {
      name: 'Scalp Balancing Sake Rinse',
      brand: 'NatureLab Tokyo',
      buy_links: [
        {
          url: 'https://www.ulta.com/p/perfect-clean-scalp-rinse-pimprod2037622?sku=2603016',
          retailer: 'Ulta',
        },
        {
          url: 'https://amzn.to/42WaUfL',
          retailer: 'Amazon',
        },
      ],
      product_categories: ['treatments'],
      ...
      description:
        'A nourishing Japanese sake rinse that restores your scalp’s natural balance while removing buildup and impurities for optimal scalp health',
      id: 'scalp_balancing_sake_rinse',
      systems_excluded: [],
      status: 'caution',
      extensions: {
        frizzbot: {
