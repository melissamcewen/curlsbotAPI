...
export const defaultProductDatabase: ProductDatabase = {
  "products": {
    ...
    "behentrimonium_chloride_2%_conditioner": {
      ...
      "description": "With only 7 ingredients and no oils, this conditioner is ideal for those with low porosity hair.",
      "buy_links": [
        {
    ...
    "deep_conditioning_treatment": {
      ...
      "asin": "B00684AC82",
      "description": "A deeply moisturizing conditioner ideal for daily use on coarse hair or as a treatment for medium textures, delivering intense hydration with a rich, herbal blend and no buildup",
    ...
    "curl_boosting_hair_mousse": {
      ...
      "ingredients_raw": "water, isobutane, propane, polyquaternium-4, phenoxyethanol, propylene glycol, fragrance, c9-11 pareth-8, caprylyl glycol, 12-hexanediol, disodium edta, citric acid",
      "tags": [
        "normal_porosity",
        "volume",
        "low_porosity",
    ...
    "perfect_volume_thickening_&_conditioning_hair_masque": {
      ...
      "id": "perfect_volume_thickening_&_conditioning_hair_masque",
      "systems_excluded": [],
      "status": "caution",
      "extensions": {
        "frizzbot": {
    ...
    "curl_defining_solid_shampoo": {
      ...
      "id": "curl_defining_solid_shampoo",
      "systems_excluded": [],
      "status": "ok",
      "extensions": {
        "frizzbot": {
    ...
    "curl_defining_solid_conditioner": {
      ...
      "id": "curl_defining_solid_conditioner",
      "systems_excluded": [],
      "status": "ok",
      "extensions": {
        "frizzbot": {
    ...
    "strictly_curls_curl_envy_cream": {
      ...
      "id": "strictly_curls_curl_envy_cream",
      "systems_excluded": [],
      "status": "warning",
      "extensions": {
        "frizzbot": {
    ...
    "the_curl_friend_curl_shape_&_stay_gel_to_foam": {
      ...
      "id": "the_curl_friend_curl_shape_&_stay_gel_to_foam",
      "systems_excluded": [],
      "status": "ok",
      "extensions": {
        "frizzbot": {
