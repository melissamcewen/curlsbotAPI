...
export const defaultProductDatabase: ProductDatabase = {
  products: {
    ...
    mud_pie_clay_clarifying_treatment: {
      ...
      brand: 'Ecoslay',
      ingredients_raw:
        'distilled water, aloe barbadensis leaf juice, cirtus aurantium amara distillate, bentonite, propanediol, apple cider vinegar, dermasoft eco 1388, potassium sorbate, sodium thiosulfate',
    ...
    clarifying_shampoo: {
      ...
      brand: 'Moroccanoil',
      product_categories: ['clarifying_shampoos'],
      tags: ['low_porosity', 'normal_porosity', 'featured'],
      buy_links: [
        {
      ...
      description:
        "This shampoo has some stronger cleansers, but that's fine in a clarifying shampoo because you're only using it once in a while. It's sulfate-free, so it won't strip your hair too much. It's also got some nice oils in it to help keep your hair from getting too dry.",
      asin: 'B0089NVH5W',
      ingredients_raw:
      ...
      extensions: {
        frizzbot: {
          ...
          emollients: ['Argan Oil', 'Avocado Oil', 'Castor Oil'],
          score: -68,
        },
        porosity: {
          high: 51,
    ...
    water_works_clarifying_shampoo: {
      ...
      description:
        'This clarifying shampoo contains sulfates, making it ideal for occasional use to remove product buildup, especially for those with low-porosity hair. While effective, it may be drying. To minimize this, focus application on the scalp and consider adding conditioner to the ends.',
    ...
    natural_detox_hair_mask: {
      ...
      brand: 'Innersense',
      product_categories: ['clarifying_shampoos'],
      tags: ['low_porosity', 'normal_porosity', 'high_porosity', 'featured'],
      ingredients_raw:
    ...
    daily_conditioner: {
      ...
      product_categories: ['conditioners'],
      tags: ['normal_porosity', 'high_porosity'],
      ingredients_raw:
    ...
    hydrating_cream_conditioner: {
      ...
      product_categories: ['conditioners'],
      tags: ['high_porosity', 'normal_porosity'],
      buy_links: [
        {
    ...
    'behentrimonium_chloride_2%_conditioner': {
      ...
      brand: 'The Ordinary',
      product_categories: ['conditioners'],
      tags: ['normal_porosity', 'low_porosity'],
      cost: 1.3,
      ingredients_raw:
    ...
    repairing_conditioner: {
      ...
      product_categories: ['conditioners'],
      tags: ['woman_owned', 'small_business'],
      buy_links: [
        {
      ...
      extensions: {
        frizzbot: {
          ...
          emollients: ['Jojoba Oil', 'Olive Oil', 'Sunflower Oil'],
          score: -75,
        },
        porosity: {
          high: 51,
    ...
    curl_conditioner: {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 2,
          emollients_number: 6,
          simple_humectants: ['Lactic Acid', 'Ethylhexylglycerin'],
          film_forming_humectants: ['Hydroxyethylcellulose', 'Algae Extract'],
          emollients: [
            'Cetyl Alcohol',
            'Stearyl Alcohol',
            'Stearamidopropyl Dimethylamine',
    ...
    curl_shaper_double_duty_weightless_cleansing_conditioner: {
      ...
      description:
        'A gentle low pH cleanser. Has a drying alcohol (isopropyl alcohol) but low on the ingredients list and this is less of a concern in a wash-out product.',
    ...
    lemon_buttercream_styling_cream: {
      ...
      tags: ['featured', 'black_owned', 'woman_owned', 'small_business'],
      ingredients_raw:
    ...
    i_create_volume: {
      ...
      tags: ['normal_porosity', 'low_porosity', 'volume', 'featured'],
      asin: 'B002EOSVUQ',
      cost: 2.8,
      id: 'i_create_volume',
      systems_excluded: [],
    ...
    cruise_control_curl_cream: {
      ...
      product_categories: ['creams'],
      tags: ['high_porosity', 'normal_porosity', 'curl_enhancer', 'featured'],
      ingredients_raw:
    ...
    deep_conditioning_treatment: {
      ...
      product_categories: ['deep_conditioners'],
      tags: ['high_porosity', 'featured', 'normal_porosity'],
      cost: 1.2,
      ingredients_raw:
    ...
    'deep_conditioner_&_repair': {
      ...
      product_categories: ['deep_conditioners', 'featured'],
      tags: ['low_porosity', 'normal_porosity', 'high_porosity', 'featured'],
      asin: 'B09YMWHVHD',
      cost: 3.38,
    ...
    double_cream_deep_quencher: {
      ...
      brand: 'Curlsmith',
      product_categories: ['deep_conditioners'],
      tags: ['high_porosity', 'normal_porosity', 'featured', 'low_porosity'],
      ingredients_raw:
    ...
    chutzpah_volumising_foam: {
      ...
      product_categories: ['foams'],
      tags: ['low_porosity', 'curl_enhancer', 'normal_porosity', 'featured'],
      ingredients_raw:
    ...
    i_create_lift_volumizing_foam: {
      ...
      product_categories: ['foams'],
      tags: ['normal_porosity', 'volume', 'low_porosity', 'featured'],
      asin: 'B079B3HKZK',
      ingredients_raw:
    ...
    curl_boosting_hair_mousse: {
      ...
      tags: ['normal_porosity', 'volume', 'low_porosity'],
      buy_links: [
        {
    ...
    'coil_infusion®_good_shape®_defining_gel': {
      ...
      brand: 'Ouidad',
      product_categories: ['gels'],
      tags: ['normal_porosity', 'high_porosity', 'featured'],
      cost: 3.5,
      buy_links: [
        {
    ...
    i_create_hold: {
      ...
      product_categories: ['gels'],
      tags: ['normal_porosity', 'hold', 'high_porosity', 'featured'],
      cost: 2.8,
      ingredients_raw:
    ...
    irish_sea_moss_styling_gel: {
      ...
      product_categories: ['gels'],
      tags: ['low_porosity', 'normal_porosity', 'hold', 'featured'],
      buy_links: [
        {
    ...
    pow_strong_hold_gel: {
      ...
      product_categories: ['gels'],
      tags: ['normal_porosity', 'low_porosity', 'hold', 'featured'],
      buy_links: [
        {
    ...
    oomph_hydrating_gel: {
      ...
      product_categories: ['gels'],
      tags: ['normal_porosity', 'high_porosity', 'volume', 'featured'],
      buy_links: [
        {
    ...
    'curl_keeper®_original_liquid_styler': {
      ...
      brand: 'Curl Keeper',
      product_categories: ['gels', 'fragrance-free'],
      tags: ['normal_porosity', 'low_porosity', 'featured'],
      cost: 2.9,
      buy_links: [
        {
    ...
    spiralicious: {
      ...
      product_categories: ['gels'],
      tags: ['low_porosity', 'normal_porosity', 'featured', 'liquid_gels'],
      buy_links: [
        {
    ...
    wash_and_go_flaxseed_gel: {
      ...
      brand: 'CurlMix',
      ingredients_raw:
        'water, linum usitatissimum flaxseed gel, ricinus communis castor oil, glycerin, xanthan gum, vitamin e, phenoxyethanol, caprylyl glycol',
      product_categories: ['gels'],
      tags: [
        'hold',
        'black_owned',
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants: ['Flaxseed Extract'],
          emollients: ['Castor Oil', 'Xanthan Gum'],
          score: -70,
        },
        porosity: {
          high: 81,
    ...
    'sweet_spirit_leave-in_conditioner': {
      ...
      product_categories: ['leave_ins'],
      tags: ['high_porosity', 'normal_porosity', 'featured'],
      cost: 2.8,
      asin: 'B004KM1OEK',
      ingredients_raw:
    ...
    refreshing_curls_leave_in_treatment: {
      ...
      tags: [],
      ingredients_raw:
        'distilled water, slippery elm, marshmallow root extract, glycerin, sorbitol, wheat germ oil, sunflower seed oil, apricot oil, cetearyl alcohol, panthenol provitmain b5, behentrimonium methosulfate, behentrimonium chloride, tocopheryl, phenoxyethanol, potassium sorbate, citric acid',
      buy_links: [
        {
      ...
      extensions: {
        frizzbot: {
          ...
          film_forming_humectants_number: 1,
          emollients_number: 5,
          simple_humectants: ['Glycerin', 'Sorbitol', 'Panthenol'],
          film_forming_humectants: ['Marshmallow root Extract'],
          emollients: [
            'Sunflower Oil',
            'Apricot Kernel Oil',
    ...
    'vitalcurl+_clear_&_gentle_shampoo': {
      ...
      cost: 2.8,
      product_categories: ['shampoos'],
      tags: ['low_porosity', 'normal_porosity', 'high_porosity'],
      ingredients_raw:
    ...
    gentle_shampoo: {
      ...
      brand: 'Tootilab',
      product_categories: ['shampoos'],
      tags: ['featured', 'women-owned', 'low_ph'],
      ingredients_raw:
        'water aqua, cocamidopropyl betaine, lauryl glucoside, glycerin, sodium methyl cocoyl taurate, aloe barbadensis leaf juice powder, caprylyl capryl glucoside, sodium lauroyl sarcosinate, sodium cocoamphoacetate, inulin, fragrance parfum, benzyl alcohol, polyquaternium-7, potassium sorbate, saccharide isomerate, argan oil glycereth-8 esters, guar hydroxypropyltrimonium chloride, citric acid, sodium chloride, alpha-glucan oligosaccharide, trisodium ethylenediamine disuccinate, tocopherol, helianthus annuus sunflower seed oil, sodium citrate, hexyl cinnamal',
      description:
    ...
    pure_harmony_hairbath: {
      ...
      cost: 2.25,
      product_categories: ['shampoos'],
      tags: ['low_porosity', 'normal_porosity'],
      asin: 'B074Q2CNMY',
    ...
    curl_definition_shampoo: {
      ...
      product_categories: ['shampoos'],
      tags: ['high porosity', 'low porosity'],
      cost: 0.5,
      buy_links: [
        {
    ...
    energizing_shampoo: {
      ...
      description:
        'Like all Curl Keeper products, this shampoo has a low pH, which helps to keep the hair cuticle closed and prevent moisture loss.',
      ingredients_raw:
