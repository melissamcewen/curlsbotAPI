...
/**
 * Test fallback database for unit tests.
 * This contains test versions of the unknown ingredient matchers.
 */
export const testFallbackDatabase: IngredientDatabase = {
  ingredients: {
    unknown_test_silicone: {
      id: 'unknown_test_silicone',
      name: 'Unknown Test Silicone',
      categories: ['non-water-soluble_silicones'],
      synonyms: [
        'cone',
        'dimethicon',
    ...
    unknown_test_water_soluble_silicone: {
      id: 'unknown_test_water_soluble_silicone',
      name: 'Unknown Test Water Soluble Silicone',
      categories: ['water-soluble_silicones'],
      synonyms: ['peg', 'ppg', 'pg-'],
    },
    unknown_test_sulfate: {
      id: 'unknown_test_sulfate',
      name: 'Unknown Test Sulfate',
      categories: ['sulfates'],
      synonyms: ['sulfate', 'sulphate'],
    },
    unknown_test_cocoyl_sulfate: {
      id: 'unknown_test_cocoyl_sulfate',
      name: 'Unknown Test Cocoyl Sulfate',
      categories: ['sulfates'],
      synonyms: ['cocosulfate', 'coco-sulfate'],
    },
  },
  categories: testDatabase.categories,
  groups: testDatabase.groups,
};
